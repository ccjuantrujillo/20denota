...
INSERT INTO `acta` (`ACTAP_Codigo`, `USUA_Codigo`, `PROP_Codigo`, `TIPCICLOP_Codigo`, `ACTAC_Tipo`, `ACTAC_Fecha`, `ACTAC_Numero`, `ACTAC_Titulo`, `ACTAC_Agenda`, `ACTAC_Detalle`, `ACTAC_Hinicio`, `ACTAC_Hfin`, `ACTAC_FechaModificacion`, `ACTAC_FechaRegistro`) VALUES
	(1, 7, 5, 1, '', '2015-09-21', 2, 'fsdfssfsdf', 'sdf ggg uuu aaaaaa ffff uu', '', '00:00:00', '09:01:00', '2015-09-24 14:13:56', '2015-09-21 13:00:18'),
	(18, 7, 8, 1, '', '2015-09-24', 11, 'ultima', '', '', '00:00:00', '00:00:00', '2015-09-24 14:13:57', '2015-09-24 06:58:26'),
	(19, 7, 5, 1, '', '2015-09-24', 33, 'Acta de Geometria', 'Prueba para todos martin', '', '08:11:00', '11:20:00', '2015-09-24 15:18:23', '2015-09-24 07:05:40');
...
INSERT INTO `actadetalle` (`ACTADETP_Codigo`, `PROP_Codigo`, `ACTAP_Codigo`, `ACTADETC_Nombre`, `ACTADETC_Observacion`, `ACTADETC_FechaCompromiso`, `ACTADETC_FechaModificacion`, `ACTADETC_FechaRegistro`) VALUES
	(73, 5, 1, NULL, '', '0000-00-00', NULL, '2015-09-24 06:32:06'),
	(75, 5, 1, NULL, '', '0000-00-00', NULL, '2015-09-24 06:32:10'),
	(77, 5, 1, NULL, '', '0000-00-00', NULL, '2015-09-24 06:32:11'),
	(81, 8, 18, NULL, 'ae', '2015-09-16', NULL, '2015-09-24 07:00:41'),
	(82, 9, 18, NULL, 'erw', '0000-00-00', NULL, '2015-09-24 07:00:41'),
	(83, 8, 18, NULL, 'werwer', '2015-09-04', NULL, '2015-09-24 07:00:41'),
	(84, 9, 18, NULL, 'rwewerwer', '0000-00-00', NULL, '2015-09-24 07:00:41'),
	(85, 5, 19, 'ruth 1', 'hola 1', '0000-00-00', NULL, '2015-09-24 07:05:40'),
	(86, 5, 19, 'ruth2', 'hOLA 2', '0000-00-00', NULL, '2015-09-24 07:05:40');
...
-- Volcando datos para la tabla 20denota.actaprofesor: ~5 rows (aproximadamente)
...
INSERT INTO `asignacion` (`ASIGP_Codigo`, `PROP_Codigo`, `CICLOP_Codigo`, `ASIGC_Descripcion`, `ASIGC_Fecha`, `ASIGC_FlagEstado`, `ASIGC_FechaModificacion`, `ASIGC_FechaRegistro`) VALUES
	...
	(26, 11, 1, '0', '2015-09-21 00:00:00', '1', NULL, '2015-09-21 12:56:28');
...
INSERT INTO `asignaciondetalle` (`ASIGDETP_Codigo`, `ASIGP_Codigo`, `AULAP_Codigo`, `TIPCICLOP_Codigo`, `ASIGDETC_Dia`, `ASIGDETC_Desde`, `ASIGDETC_Hasta`, `ASIGDETC_FechaModificacion`, `ASIGDETC_FechaRegistro`) VALUES
	(2, 17, 1, 5, 1, '08:00:00', '10:00:00', NULL, '2015-09-21 12:37:07'),
	(3, 17, 2, 5, 3, '08:00:00', '11:00:00', '2015-09-21 12:41:05', '2015-09-21 12:37:07'),
	...
	(14, 26, 13, 2, 1, '00:00:00', '00:00:00', NULL, '2015-09-21 12:56:28'),
	(15, 26, 13, 2, 1, '00:00:00', '00:00:00', NULL, '2015-09-21 12:56:28'),
	(16, 26, 1, 1, 1, '00:00:00', '00:00:00', NULL, '2015-09-21 12:56:28'),
	(17, 26, 13, 2, 2, '00:00:00', '00:00:00', NULL, '2015-09-21 12:56:28');
...
INSERT INTO `menu` (`MENU_Codigo`, `MENU_Codigo_Padre`, `MENU_Descripcion`, `MENU_Comentario`, `MENU_Url`, `MENU_Orden`, `MENU_Imagen`, `MENU_FechaRegistro`, `MENU_FechaModificacion`, `MENU_FlagEstado`) VALUES
	...
	(67, 4, 'Reuniones de plana', 'Actas de reunion', 'index.php/ventas/acta/listar', 1, NULL, '2015-09-24 11:39:58', NULL, '1'),
	(68, 4, 'Tareas', 'Tareas asignadas', 'index.php/ventas/tarea/listar', 1, NULL, '2015-09-29 13:59:34', NULL, '1'),
...
INSERT INTO `tarea` (`TAREAP_Codigo`, `USUA_Codigo`, `PROP_Codigo`, `CICLOP_Codigo`, `TIPOTAREAP_Codigo`, `TAREAC_Nombre`, `TAREAC_Descripcion`, `TAREAC_Fecha`, `TAREAC_FechaEntrega`, `TAREAC_Numero`, `TAREAC_FechaModificacion`, `TAREAC_FechaRegistro`) VALUES
	...
	(5, 7, 5, 1, 1, 'ertertertertre treterter tr', 'ertertertert', '2015-09-29', '0000-00-00', 100, '2015-09-29 16:49:44', '2015-09-29 16:13:41');
...
CREATE TABLE IF NOT EXISTS `tareadetalle` (
  ...
  `TAREADETC_Cantidad` int(11) DEFAULT NULL,
...
-- Volcando datos para la tabla 20denota.tareadetalle: ~1 rows (aproximadamente)
...
INSERT INTO `tareadetalle` (`TAREADETP_Codigo`, `TAREAP_Codigo`, `PROP_Codigo`, `PRODATRIBDET_Codigo`, `TAREADETC_Cantidad`, `TAREADETC_FechaEntrega`, `TAREADETC_FechaModificacion`, `TAREADETC_FechaRegistro`) VALUES
	(1, 5, 8, 5, 20, '0000-00-00', '2015-09-29 16:14:18', '2015-09-29 15:12:02');
...
INSERT INTO `tareo` (`TAREOP_Codigo`, `PROP_Codigo`, `AULAP_Codigo`, `TAREOC_ProfesorReemplazado`, `TAREOC_Fecha`, `TAREOC_Hinicio`, `TAREOC_Hfin`, `TAREOC_Tipo`, `TAREOC_Costo`, `TAREOC_FechaModificacion`, `TAREOC_FechaRegistro`) VALUES
	(1, 7, 1, 0, '2015-07-31', '08:00:00', '10:00:00', 3, 0, '2015-09-24 16:39:16', '2015-07-29 22:50:36'),
	(7, 10, 1, 0, '2015-07-31', '17:12:00', '17:12:00', 3, 0, '2015-09-24 17:14:25', '2015-09-24 17:12:32');
