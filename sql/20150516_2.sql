...
CREATE TABLE IF NOT EXISTS `tipoestudio` (
  ...
  `TIPC_Tipo` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `tipoestudio` (`TIPP_Codigo`, `TIPC_Nombre`, `TIPC_Descripcion`, `TIPC_Tipo`, `TIPC_FechaRegistro`) VALUES
	(1, 'Pre', NULL, 1, '2015-05-15 04:18:57'),
	(2, 'Basico', NULL, 1, '2015-05-15 04:19:14'),
	(3, 'Pre', NULL, 2, '2015-05-15 04:19:44'),
	(4, 'Repaso', NULL, 2, '2015-05-15 04:19:49'),
	(5, 'Basico', NULL, 2, '2015-05-15 04:20:23'),
	(6, 'Intensivo', NULL, 2, '2015-05-15 04:20:28');
