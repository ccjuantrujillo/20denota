...
-- Volcando datos para la tabla 20denota.menu: ~16 rows (aproximadamente)
DELETE FROM `menu`;
...
INSERT INTO `menu` (`MENU_Codigo`, `MENU_Codigo_Padre`, `MENU_Descripcion`, `MENU_Comentario`, `MENU_Url`, `MENU_Imagen`, `MENU_FechaRegistro`, `MENU_FechaModificacion`, `MENU_FlagEstado`) VALUES
	...
	(58, 3, 'Usuario', NULL, 'index.php/seguridad/usuario/listar', NULL, '2015-06-20 21:30:00', NULL, '1'),
...
-- Volcando datos para la tabla 20denota.permiso: ~14 rows (aproximadamente)
DELETE FROM `permiso`;
