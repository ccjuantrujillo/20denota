...
-- Volcando datos para la tabla 20denota.acceso: ~15 rows (aproximadamente)
DELETE FROM `acceso`;
...
-- Volcando datos para la tabla 20denota.conferencia: ~7 rows (aproximadamente)
...
INSERT INTO `conferencia` (`CONFERP_Codigo`, `PROP_Codigo`, `CONFERC_Nombre`, `CONFERC_Descripcion`, `CONFERC_Fecha`, `CONFERC_FechaModificacion`, `CONFERC_FechaRegistro`) VALUES
	...
	(4, 53, 'Ana Paola', 'HOp asdf', '2015-11-12', NULL, '2015-11-16 11:08:29'),
	(5, 53, 'Los expedientes secretos 2', 'David Scully', '2015-11-04', NULL, '2015-11-16 11:10:07'),
	(6, 53, 'asd', 'asd', '2015-11-11', NULL, '2015-11-27 00:13:52'),
	(7, 53, 'Las leyes espirituales del exito', 'Depack Chopra', '2015-11-10', NULL, '2015-11-27 00:16:16'),
	(8, 53, 'Shakira', 'asdf', '2015-11-04', NULL, '2015-11-27 00:29:00');
...
INSERT INTO `empresa` (`EMPRP_Codigo`, `SECTORP_Codigo`, `EMPRC_Ruc`, `EMPRC_RazonSocial`, `EMPRC_Telefono`, `EMPRC_Movil`, `EMPRC_Fax`, `EMPRC_Web`, `EMPRC_Email`, `EMPRC_Direccion`, `EMPRC_FlagEstado`, `EMPRC_FechaModificacion`, `EMPRC_FechaRegistro`) VALUES
...
-- Volcando datos para la tabla 20denota.estudios: ~7 rows (aproximadamente)
...
INSERT INTO `estudios` (`ESTUDIOP_Codigo`, `PROP_Codigo`, `UNIVP_Codigo`, `GRADOP_Codigo`, `ESTUDIOC_Descripcion`, `ESTUDIOC_Estado`, `ESTUDIOC_FechaInicio`, `ESTUDIOC_FechaFin`, `ESTUDIOC_FechaModificacion`, `ESTUDIOC_FechaRegistro`) VALUES
	...
	(8, 53, 4, 3, 'Economia de la energia', '1', '1952-12-01', '1968-12-01', NULL, '2015-11-09 08:30:22');
...
INSERT INTO `estudiosidiomas` (`ESTIDIOMP_Codigo`, `PROP_Codigo`, `IDIOMP_Codigo`, `ESTIDIOMC_Descripcion`, `ESTIDIOMC_Nivel`, `ESTIDIOMC_Estado`, `ESTIDIOMC_FechaInicio`, `ESTIDIOMC_FechaFin`, `ESTIDIOMC_FechaModificacion`, `ESTIDIOMC_FechaRegistro`) VALUES
	...
	(5, 53, 3, '0', '3', '1', '1952-08-00', '1955-07-00', NULL, '2015-11-16 08:09:16'),
...
-- Volcando datos para la tabla 20denota.experiencia: ~15 rows (aproximadamente)
...
INSERT INTO `experiencia` (`EXPERP_Codigo`, `UNIVP_Codigo`, `PROP_Codigo`, `EXPERPC_Cargo`, `EXPERPC_Empresa`, `EXPERPC_Curso`, `EXPERPC_FechaInicio`, `EXPERPC_FechaFin`, `EXPERPC_FechaModificacion`, `EXPERPC_FechaRegistro`) VALUES
	...
	(19, 16, 53, 'Docente', '0', 'Matematicas IIII', '1952-12-00', '1952-05-00', NULL, '2015-11-16 09:07:18'),
	...
	(30, 5, 53, 'adfasd', '0', 'adsfasdf', '1954-05-00', '1953-06-00', NULL, '2015-11-24 06:55:08'),
	(31, 12, 53, 'Historia', '0', 'del ARte MOderno', '1954-07-00', '1959-07-00', NULL, '2015-11-24 06:55:31'),
	(35, 1, 53, 'qwerqwer', '0', 'qwerqwer', '1956-03-00', '1958-06-00', NULL, '2015-11-24 06:58:25');
...
-- Volcando datos para la tabla 20denota.grado: ~4 rows (aproximadamente)
DELETE FROM `grado`;
...
-- Volcando datos para la tabla 20denota.menu: ~31 rows (aproximadamente)
DELETE FROM `menu`;
...
-- Volcando datos para la tabla 20denota.permiso: ~52 rows (aproximadamente)
DELETE FROM `permiso`;
...
-- Volcando datos para la tabla 20denota.persona: ~56 rows (aproximadamente)
DELETE FROM `persona`;
...
CREATE TABLE IF NOT EXISTS `profesor` (
  ...
  `PROC_FlagBorrado` char(1) NOT NULL DEFAULT '1',
...
-- Volcando datos para la tabla 20denota.profesor: ~46 rows (aproximadamente)
DELETE FROM `profesor`;
/*!40000 ALTER TABLE `profesor` DISABLE KEYS */;
INSERT INTO `profesor` (`PROP_Codigo`, `PROD_Codigo`, `PERSP_Codigo`, `PROC_FlagCoordinador`, `PROC_FlagEstado`, `PROC_FlagBorrado`, `PROC_FechaModificacion`, `PROC_FechaRegistro`) VALUES
	(5, 93, 91, 2, '1', '1', '2015-10-16 22:42:56', '2015-05-16 09:00:24'),
	(6, 93, 93, 2, '1', '1', '2015-05-16 00:00:00', '2015-05-16 12:24:00'),
	(7, 93, 94, 1, '1', '1', '2015-10-16 16:50:38', '2015-05-16 12:25:47'),
	(8, 5, 97, 1, '1', '1', '2015-10-16 19:39:04', '2015-05-30 05:31:56'),
	(9, 5, 98, 2, '1', '1', '2015-07-27 00:00:00', '2015-07-27 16:08:29'),
	(10, 5, 99, 2, '1', '1', '2015-07-27 00:00:00', '2015-07-27 16:09:18'),
	(11, 92, 100, 2, '1', '1', '2015-10-16 19:32:33', '2015-07-27 16:12:47'),
	(12, 95, 101, 2, '1', '1', '2015-07-27 00:00:00', '2015-07-27 16:14:37'),
	(14, 95, 138, 2, '1', '0', '2015-10-16 16:07:22', '2015-10-16 09:07:22'),
	(15, 95, 139, 2, '1', '1', '2015-10-16 16:08:19', '2015-10-16 09:08:19'),
	(17, 95, 141, 2, '1', '1', '2015-10-16 16:09:40', '2015-10-16 09:09:40'),
	(18, 95, 142, 2, '1', '1', '2015-10-16 16:09:59', '2015-10-16 09:09:59'),
	(19, 95, 143, 2, '1', '1', '2015-10-16 16:10:47', '2015-10-16 09:10:47'),
	(20, 95, 144, 2, '1', '1', '2015-10-16 16:11:14', '2015-10-16 09:11:14'),
	(21, 95, 145, 2, '1', '1', '2015-10-16 16:11:39', '2015-10-16 09:11:39'),
	(22, 95, 146, 2, '1', '1', '2015-10-16 16:12:16', '2015-10-16 09:12:16'),
	(23, 95, 147, 2, '1', '1', '2015-10-16 16:12:48', '2015-10-16 09:12:48'),
	(24, 95, 148, 2, '1', '1', '2015-10-16 16:13:07', '2015-10-16 09:13:07'),
	(25, 95, 149, 2, '1', '1', '2015-10-16 16:13:32', '2015-10-16 09:13:32'),
	(26, 95, 150, 2, '1', '1', '2015-10-16 16:14:06', '2015-10-16 09:14:06'),
	(27, 95, 151, 2, '1', '1', '2015-10-16 16:14:25', '2015-10-16 09:14:25'),
	(28, 95, 152, 2, '1', '1', '2015-10-16 16:14:45', '2015-10-16 09:14:45'),
	(29, 95, 153, 2, '1', '1', '2015-10-16 16:15:08', '2015-10-16 09:15:08'),
	(30, 95, 154, 2, '1', '1', '2015-10-16 16:33:28', '2015-10-16 09:33:28'),
	(31, 95, 155, 2, '1', '1', '2015-10-16 16:44:38', '2015-10-16 09:34:35'),
	(33, 95, 157, 2, '1', '1', '2015-10-16 16:45:09', '2015-10-16 09:45:09'),
	(34, 95, 158, 2, '1', '1', '2015-10-16 16:45:34', '2015-10-16 09:45:34'),
	(35, 95, 159, 2, '1', '1', '2015-10-16 16:45:58', '2015-10-16 09:45:58'),
	(36, 95, 160, 1, '1', '1', '2015-11-16 18:26:46', '2015-10-16 09:46:20'),
	(38, 96, 162, 2, '1', '1', '2015-10-16 16:47:31', '2015-10-16 09:47:31'),
	(39, 96, 163, 2, '1', '1', '2015-10-16 16:48:05', '2015-10-16 09:48:05'),
	(40, 96, 164, 2, '1', '1', '2015-10-16 16:48:24', '2015-10-16 09:48:24'),
	(41, 96, 165, 2, '1', '1', '2015-10-16 16:48:42', '2015-10-16 09:48:42'),
	(42, 96, 166, 2, '1', '1', '2015-10-16 16:49:18', '2015-10-16 09:49:18'),
	(43, 96, 167, 2, '1', '1', '2015-10-16 16:49:36', '2015-10-16 09:49:36'),
	(44, 96, 168, 2, '1', '1', '2015-10-16 16:49:59', '2015-10-16 09:49:59'),
	(45, 93, 169, 2, '1', '1', '2015-10-16 16:51:06', '2015-10-16 09:51:06'),
	(46, 93, 170, 2, '1', '1', '2015-10-16 16:51:32', '2015-10-16 09:51:32'),
	(47, 5, 171, 2, '1', '1', '2015-10-16 19:30:18', '2015-10-16 12:30:18'),
	(48, 5, 172, 2, '1', '1', '2015-10-16 19:30:45', '2015-10-16 12:30:45'),
	(49, 5, 173, 2, '1', '1', '2015-10-16 19:31:13', '2015-10-16 12:31:13'),
	(50, 92, 174, 1, '1', '0', '2015-10-16 19:32:59', '2015-10-16 12:32:59'),
	(51, 97, 175, 2, '1', '1', '2015-10-16 19:35:11', '2015-10-16 12:35:11'),
	(52, 97, 176, 2, '1', '1', '2015-10-16 19:35:36', '2015-10-16 12:35:36'),
	(53, 98, 177, 2, '1', '0', '2015-11-16 18:26:36', '2015-10-16 12:36:00'),
	(54, 98, 178, 1, '1', '1', '2015-10-16 19:36:50', '2015-10-16 12:36:26');
...
-- Volcando datos para la tabla 20denota.profesorsociedad: ~4 rows (aproximadamente)
...
INSERT INTO `profesorsociedad` (`PROFSOCP_Codigo`, `PROP_Codigo`, `SOCIEDP_Codigo`, `PROFSOCC_FechaSuscripcion`, `PROFSOCC_FechaModificacion`, `PROFSOCC_FechaRegistro`) VALUES
	...
	(6, 53, 1, '2015-11-17', NULL, '2015-11-16 11:22:47'),
...
-- Volcando datos para la tabla 20denota.semana: ~63 rows (aproximadamente)
DELETE FROM `semana`;
...
-- Volcando datos para la tabla 20denota.tarea: ~6 rows (aproximadamente)
DELETE FROM `tarea`;
...
INSERT INTO `tarea` (`TAREAP_Codigo`, `USUA_Codigo`, `PROP_Codigo`, `CICLOP_Codigo`, `TIPOTAREAP_Codigo`, `TAREAC_Nombre`, `TAREAC_Descripcion`, `TAREAC_Numero`, `TAREAC_Fecha`, `TAREAC_FechaEntrega`, `TAREAC_FechaModificacion`, `TAREAC_FechaRegistro`) VALUES
	...
	(7, 7, 54, 1, 3, 'para la practica calificada', 'afsdasdfsadf', 3, '2015-10-22', '2015-10-07', NULL, '2015-10-22 00:25:35'),
	(8, 7, 8, 1, 3, 'para el material', 'adsf', 3, '2015-10-24', '2015-10-07', NULL, '2015-10-24 07:34:39');
...
CREATE TABLE IF NOT EXISTS `tareadetalle` (
  ...
  `TAREADETC_Situacion` char(1) DEFAULT '1' COMMENT '1: Pendiente, 2:EnProceso, 3:Terminado',
...
INSERT INTO `tareadetalle` (`TAREADETP_Codigo`, `TAREAP_Codigo`, `TIPCICLOP_Codigo`, `PROP_Codigo`, `PRODATRIBDET_Codigo`, `TAREADETC_Cantidad`, `TAREADETC_CantidadEntregada`, `TAREADETC_Situacion`, `TAREADETC_FechaEntrega`, `TAREADETC_FechaModificacion`, `TAREADETC_FechaRegistro`) VALUES
	(23, 6, 1, 5, 5, '8', NULL, '1', '2015-10-21', NULL, '2015-10-24 07:12:26'),
	(24, 6, 1, 6, 11, '55', NULL, '1', '0000-00-00', NULL, '2015-10-24 07:27:11'),
	(25, 6, 1, 45, 9, '6', NULL, '1', '2015-10-13', NULL, '2015-10-24 07:29:00'),
	(26, 6, 1, 6, 15, '77', NULL, '1', '2015-10-14', NULL, '2015-10-24 07:29:00'),
	(27, 6, 5, 5, 0, '999', NULL, '1', '2015-10-13', '2015-10-24 07:33:00', '2015-10-24 07:30:47'),
	(28, 6, 1, 5, 18, '888', NULL, '1', '2015-10-28', '2015-10-24 07:32:45', '2015-10-24 07:32:18'),
	(29, 7, 1, 53, 0, '15', NULL, '1', '2015-10-14', NULL, '2015-10-24 07:33:31'),
	(30, 7, 2, 53, 0, '58', NULL, '1', '2015-10-07', NULL, '2015-10-24 07:33:31'),
	(31, 8, 1, 8, 0, '25', NULL, '1', '2015-10-07', '2015-10-26 00:25:04', '2015-10-24 07:34:39'),
	(32, 8, 2, 10, 0, '33', NULL, '1', '2015-10-14', NULL, '2015-10-24 07:34:40'),
	(33, 8, 4, 47, 0, '33', NULL, '1', '2015-10-14', NULL, '2015-10-24 07:34:40'),
	(34, 2, 2, 50, 0, '234', NULL, '1', '2015-10-14', NULL, '2015-10-24 07:38:11'),
	(35, 3, 3, 9, 0, '234', NULL, '1', '2015-10-06', NULL, '2015-10-24 07:38:47'),
	(36, 3, 4, 9, 0, '32', NULL, '1', '2015-10-13', NULL, '2015-10-24 07:38:47'),
	(37, 8, 1, 9, 0, '5555', NULL, '1', '0000-00-00', NULL, '2015-10-26 00:25:20');
...
-- Volcando datos para la tabla 20denota.tema: ~34 rows (aproximadamente)
DELETE FROM `tema`;
...
-- Volcando datos para la tabla 20denota.tipoproducto: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla 20denota.trabajo: ~2 rows (aproximadamente)
DELETE FROM `trabajo`;
...
INSERT INTO `trabajo` (`TRABAJP_Codigo`, `PROP_Codigo`, `EMPRP_Codigo`, `TRABAJC_Descripcion`, `TRABAJC_FechaInicio`, `TRABAJC_FechaFin`, `TRABAJC_FechaModificacion`, `TRABAJC_FechaRegistro`) VALUES
	...
	(3, 53, 1, 'Jefe de galvanizado', '1952-04-00', '1956-03-00', NULL, '2015-11-16 12:05:05');
...
CREATE TABLE IF NOT EXISTS `vigilancia` (
  ...
  CONSTRAINT `FK_vigilancia_tipoestudiociclo` FOREIGN KEY (`TIPCICLOP_Codigo`) REFERENCES `tipoestudiociclo` (`TIPCICLOP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla 20denota.vigilancia: ~4 rows (aproximadamente)
DELETE FROM `vigilancia`;
/*!40000 ALTER TABLE `vigilancia` DISABLE KEYS */;
INSERT INTO `vigilancia` (`VIGILAP_Codigo`, `PROP_Codigo`, `TIPCICLOP_Codigo`, `VIGILAC_Nombre`, `VIGILAC_Numero`, `VIGILAC_Descripcion`, `VIGILAC_Fecha`, `VIGILAC_FechaModificacion`, `VIGILAC_FechaRegistro`) VALUES
	(3, 36, 1, 'Practica Calificada', 8, 'adsfasdfsadf', '2015-10-24', NULL, '2015-10-24 07:57:16'),
	(4, 7, 1, 'Practica calificada', 8, 'asdfasdfasdf', '2015-10-24', NULL, '2015-10-24 08:10:07'),
	(7, 7, 1, 'Practica calificada', 8, '2015 4 gdfdfgdfg', '2015-10-26', NULL, '2015-10-26 00:50:06'),
	(8, 36, 4, 'Practica calificada', 6, 'asdfasdfasdf', '2015-11-29', NULL, '2015-11-29 01:33:05');
...
-- Volcando datos para la tabla 20denota.vigilanciadetalle: ~11 rows (aproximadamente)
...
INSERT INTO `vigilanciadetalle` (`VIGILADETP_Codigo`, `VIGILAP_Codigo`, `PROD_Codigo`, `PROP_Codigo`, `VIGILADETC_FechaModificacion`, `VIGILADETC_FechaRegistro`) VALUES
	...
	(11, 8, 92, 11, NULL, '2015-11-29 01:33:05'),
	(12, 8, 95, 20, NULL, '2015-11-29 01:33:06'),
	(13, 8, 96, 40, NULL, '2015-11-29 01:33:06'),
	(14, 8, 96, 41, NULL, '2015-11-29 01:33:23'),
	(15, 3, 96, 41, NULL, '2015-11-29 01:33:55');
