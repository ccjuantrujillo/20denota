...
-- Volcando datos para la tabla 20denota.acceso: ~17 rows (aproximadamente)
DELETE FROM `acceso`;
...
-- Volcando datos para la tabla 20denota.menu: ~32 rows (aproximadamente)
DELETE FROM `menu`;
...
-- Volcando datos para la tabla 20denota.permiso: ~53 rows (aproximadamente)
DELETE FROM `permiso`;
...
-- Volcando datos para la tabla 20denota.persona: ~55 rows (aproximadamente)
DELETE FROM `persona`;
...
-- Volcando datos para la tabla 20denota.semana: ~48 rows (aproximadamente)
DELETE FROM `semana`;
...
-- Volcando datos para la tabla 20denota.tema: ~25 rows (aproximadamente)
DELETE FROM `tema`;
