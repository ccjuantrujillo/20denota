...
-- Volcando datos para la tabla 20denota.acta: ~2 rows (aproximadamente)
DELETE FROM `acta`;
...
-- Volcando datos para la tabla 20denota.actadetalle: ~7 rows (aproximadamente)
...
INSERT INTO `menu` (`MENU_Codigo`, `MENU_Codigo_Padre`, `MENU_Descripcion`, `MENU_Comentario`, `MENU_Url`, `MENU_Orden`, `MENU_Imagen`, `MENU_FechaRegistro`, `MENU_FechaModificacion`, `MENU_FlagEstado`) VALUES
	...
	(70, 4, 'Tardanzas Reemplazos', 'Tardanzas Reemplazos', 'index.php/ventas/tareo/editar', 3, NULL, '2015-10-06 15:46:31', NULL, '1'),
...
INSERT INTO `tarea` (`TAREAP_Codigo`, `USUA_Codigo`, `PROP_Codigo`, `CICLOP_Codigo`, `TIPOTAREAP_Codigo`, `TAREAC_Nombre`, `TAREAC_Descripcion`, `TAREAC_Fecha`, `TAREAC_FechaEntrega`, `TAREAC_Numero`, `TAREAC_FechaModificacion`, `TAREAC_FechaRegistro`) VALUES
	...
	(5, 7, 5, 1, 1, 'ertertertertre treterter tr', 'ertertertert ttttt dddd', '2015-09-29', '0000-00-00', 100, '2015-10-06 15:49:13', '2015-09-29 16:13:41');
...
INSERT INTO `tareadetalle` (`TAREADETP_Codigo`, `TAREAP_Codigo`, `PROP_Codigo`, `PRODATRIBDET_Codigo`, `TAREADETC_Cantidad`, `TAREADETC_FechaModificacion`, `TAREADETC_FechaRegistro`) VALUES
	(1, 5, 8, 5, 20, '2015-09-29 16:14:18', '2015-09-29 15:12:02'),
	(2, 5, 5, 7, 3, NULL, '2015-10-06 16:03:53');
...
-- Volcando datos para la tabla 20denota.tareo: ~9 rows (aproximadamente)
DELETE FROM `tareo`;
...
INSERT INTO `tareo` (`TAREOP_Codigo`, `PROP_Codigo`, `AULAP_Codigo`, `TAREOC_Tipo`, `USUA_Codigo`, `TAREOC_ProfesorReemplazado`, `TAREOC_Fecha`, `TAREOC_Hinicio`, `TAREOC_Hfin`, `TAREOC_Costo`, `TAREOC_FechaModificacion`, `TAREOC_FechaRegistro`) VALUES
	(1, 7, 1, 1, 7, 8, '2015-07-31', '08:00:00', '10:00:00', 0, '2015-10-06 15:37:19', '2015-07-29 22:50:36'),
	(8, 5, 1, 1, 7, 9, '2015-07-31', '02:02:00', '02:56:00', 0, NULL, '2015-10-06 15:38:08'),
	(9, 11, 1, 2, 7, 8, '2015-07-31', '00:00:00', '00:00:00', 0, NULL, '2015-10-06 15:40:20'),
	(10, 12, 1, 2, 7, 5, '2015-07-31', '00:00:00', '00:00:00', 0, NULL, '2015-10-06 15:40:34'),
	(11, 5, 1, 1, 7, 0, '2015-10-06', '08:00:00', '02:00:00', 0, '2015-10-06 15:42:23', '2015-10-06 15:42:16'),
	(12, 11, 1, 1, 7, 7, '2015-10-06', '00:00:00', '00:00:00', 0, NULL, '2015-10-06 15:42:52'),
	(13, 11, 1, 2, 7, 9, '2015-10-06', '00:00:00', '00:00:00', 0, NULL, '2015-10-06 15:43:54'),
	(14, 11, 2, 2, 7, 9, '2015-10-06', '00:00:00', '00:00:00', 0, NULL, '2015-10-06 15:44:12'),
	(15, 9, 11, 1, 7, 9, '2015-10-06', '00:00:00', '00:00:00', 0, NULL, '2015-10-06 15:44:27');
