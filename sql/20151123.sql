...
CREATE TABLE IF NOT EXISTS `acceso` (
  ...
  `ACCESOC_Fecha` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Volcando datos para la tabla 20denota.acceso: ~0 rows (aproximadamente)
DELETE FROM `acceso`;
...
-- Volcando datos para la tabla 20denota.trabajo: ~3 rows (aproximadamente)
DELETE FROM `trabajo`;
