...
-- Volcando datos para la tabla 20denota.permiso: ~27 rows (aproximadamente)
DELETE FROM `permiso`;
...
-- Volcando datos para la tabla 20denota.tareadetalle: ~7 rows (aproximadamente)
...
INSERT INTO `vigilancia` (`VIGILAP_Codigo`, `VIGILAC_Nombre`, `VIGILAC_Descripcion`, `VIGILAC_Fecha`, `VIGILAC_FechaModificacion`, `VIGILAC_FechaRegistro`) VALUES
	(1, 'werwer', 'werwer', '2015-10-09', NULL, '2015-10-09 22:36:42');
