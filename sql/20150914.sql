...
-- Volcando datos para la tabla 20denota.cursotipoestudio: ~8 rows (aproximadamente)
...
INSERT INTO `cursotipoestudio` (`CURSOTIPOP_Codigo`, `CURSOCIP_Codigo`, `TIPP_Codigo`, `CURSOTIPOC_FlagEstado`, `CURSOTIPOC_FechaModificacion`, `CURSOTIPOC_FechaRegistro`) VALUES
	...
	(7, 7, 3, '1', NULL, '2015-09-10 00:20:48'),
	(8, 4, 9, '1', NULL, '2015-09-10 02:35:13');
...
INSERT INTO `menu` (`MENU_Codigo`, `MENU_Codigo_Padre`, `MENU_Descripcion`, `MENU_Comentario`, `MENU_Url`, `MENU_Orden`, `MENU_Imagen`, `MENU_FechaRegistro`, `MENU_FechaModificacion`, `MENU_FlagEstado`) VALUES
	...
	(59, 74, 'Aula', NULL, 'index.php/maestros/aula/listar', 5, NULL, '2015-09-08 00:13:43', NULL, '1'),
	(61, 74, 'Local', NULL, 'index.php/maestros/local/listar', 4, NULL, '2015-09-08 00:13:39', NULL, '1'),
	...
	(72, 74, 'Semana', 'Semana', 'index.php/almacen/semana/listar', 3, NULL, '2015-09-08 00:21:03', NULL, '1'),
...
-- Volcando datos para la tabla 20denota.semana: ~65 rows (aproximadamente)
DELETE FROM `semana`;
...
INSERT INTO `semana` (`PRODATRIB_Codigo`, `CICLOP_Codigo`, `TIPP_Codigo`, `PRODATRIB_Nombre`, `PRODATRIB_Descripcion`, `PRODATRIB_FechaInicio`, `PRODATRIB_FechaFin`, `PRODATRIB_FechaModificacion`, `PRODATRIB_FechaRegistro`) VALUES
	...
	(24, 1, 5, 'Semana 09u', '', '0000-00-00', '0000-00-00', '2015-09-10 01:17:20', '2015-05-12 11:57:50'),
	...
	(73, 1, 8, 'Semana 01', '', '2015-09-01', '2015-09-02', NULL, '2015-09-10 02:42:13'),
	(74, 1, 8, 'Semana 02', '', '2015-09-01', '2015-09-01', NULL, '2015-09-10 02:42:38'),
	(75, 1, 8, 'Semana 03', '', '2015-09-01', '2015-09-02', NULL, '2015-09-10 02:43:02'),
	(76, 1, 8, 'Semana 04', '', '2015-09-02', '2015-09-10', NULL, '2015-09-10 02:43:19'),
	(77, 1, 8, 'Semana 05', '', '2015-09-02', '2015-09-17', NULL, '2015-09-10 02:43:34'),
	(78, 1, 8, 'Semana 06', '', '2015-09-02', '2015-09-02', NULL, '2015-09-10 02:43:51'),
	(79, 1, 8, 'Semana 07', '', '2015-09-02', '2015-09-09', NULL, '2015-09-10 02:44:07'),
	(80, 1, 8, 'Semana 08', '', '2015-09-02', '2015-09-10', NULL, '2015-09-10 02:44:24');
...
CREATE TABLE IF NOT EXISTS `tema` (
  ...
  `CURSOTIPOP_Codigo` int(11) NOT NULL,
  `PRODATRIB_Codigo` int(11) NOT NULL,
  ...
  KEY `FK_tema_cursotipoestudio` (`CURSOTIPOP_Codigo`),
  CONSTRAINT `FK_tema_cursotipoestudio` FOREIGN KEY (`CURSOTIPOP_Codigo`) REFERENCES `cursotipoestudio` (`CURSOTIPOP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Volcando datos para la tabla 20denota.tema: ~67 rows (aproximadamente)
DELETE FROM `tema`;
/*!40000 ALTER TABLE `tema` DISABLE KEYS */;
INSERT INTO `tema` (`PRODATRIBDET_Codigo`, `CURSOTIPOP_Codigo`, `PRODATRIB_Codigo`, `PRODATRIBDET_Numero`, `PRODATRIBDET_Descripcion`, `PRODATRIBDET_FechaModificacion`, `PRODATRIBDET_FechaRegistro`) VALUES
	(12, 3, 36, 0, 'Nociones basicas', NULL, '2015-09-10 02:08:20'),
	(13, 3, 36, 0, 'Segmento de recta', NULL, '2015-09-10 02:09:25'),
	(14, 3, 37, 0, 'Triangulos', NULL, '2015-09-10 02:09:43'),
	(15, 3, 37, 0, 'Correspondencias entre angulos y lados', NULL, '2015-09-10 02:10:06'),
	(16, 3, 18, 0, 'Congruencia de triangulos', NULL, '2015-09-10 02:10:28'),
	(17, 3, 18, 0, 'Aplicaciones de la conguencia', NULL, '2015-09-10 02:10:54'),
	(18, 3, 39, 0, 'Teorema de base media', NULL, '2015-09-10 02:11:17'),
	(19, 3, 39, 0, 'Poligonos', NULL, '2015-09-10 02:11:40'),
	(20, 3, 40, 0, 'Cuadrilateros', NULL, '2015-09-10 02:12:02'),
	(21, 3, 40, 0, 'Circunferencia', NULL, '2015-09-10 02:12:23'),
	(22, 3, 49, 0, 'Cuadrilatero circunscrito y circunscriptible', NULL, '2015-09-10 02:12:55'),
	(23, 3, 49, 0, 'Angulos en la circunferencia', NULL, '2015-09-10 02:13:16'),
	(24, 3, 22, 0, 'Proporcionalidad', NULL, '2015-09-10 02:13:38'),
	(25, 3, 22, 0, 'Semejanza de triangulos', NULL, '2015-09-10 02:13:58'),
	(26, 3, 23, 0, 'Relaciones metricas en el triangulo rectangulo', NULL, '2015-09-10 02:14:23'),
	(27, 3, 23, 0, 'Teorema de Heron', NULL, '2015-09-10 02:14:43'),
	(28, 3, 24, 0, 'Poligonos regulares', NULL, '2015-09-10 02:15:06'),
	(29, 3, 24, 0, 'Poligonos regulares notables inscritos', NULL, '2015-09-10 02:15:49'),
	(30, 3, 25, 0, 'Nociones de simetria en el plano', NULL, '2015-09-10 02:16:35'),
	(31, 3, 25, 0, 'Areas de regiones poligonales', NULL, '2015-09-10 02:16:58'),
	(32, 3, 26, 0, 'Relacion de areas triangulares', NULL, '2015-09-10 02:17:22'),
	(33, 3, 26, 0, 'Areas de regiones cuadrangulares', NULL, '2015-09-10 02:17:46'),
	(34, 3, 27, 0, 'Areas de regiones circulares', NULL, '2015-09-10 02:18:06'),
	(35, 3, 27, 0, 'Elementos de geometria en el espacio', NULL, '2015-09-10 02:18:29'),
	(36, 3, 28, 0, 'Teorema de las tres perpendiculares', NULL, '2015-09-10 02:18:49'),
	(37, 3, 28, 0, 'Proyeccion ortogonal', NULL, '2015-09-10 02:19:10'),
	(38, 3, 29, 0, 'Angulo Diedro', NULL, '2015-09-10 02:19:38'),
	(39, 3, 29, 0, 'Angulos Poliedros', NULL, '2015-09-10 02:19:56'),
	(40, 3, 30, 0, 'Angulo triedro', NULL, '2015-09-10 02:20:16'),
	(41, 3, 30, 0, 'Poliedros', NULL, '2015-09-10 02:20:32'),
	(42, 3, 31, 0, 'Poliedros regulares', NULL, '2015-09-10 02:20:52'),
	(43, 3, 31, 0, 'Nociones de simetria den el espacio', NULL, '2015-09-10 02:21:16'),
	(44, 3, 32, 0, 'Prisma', NULL, '2015-09-10 02:30:44'),
	(45, 3, 32, 0, 'Tronco de piramide', NULL, '2015-09-10 02:31:06'),
	(46, 3, 33, 0, 'Piramide', NULL, '2015-09-10 02:31:25'),
	(47, 3, 33, 0, 'Tronco de Piramide', NULL, '2015-09-10 02:31:44'),
	(48, 3, 34, 0, 'Cilindro', NULL, '2015-09-10 02:32:04'),
	(49, 3, 34, 0, 'Cono', NULL, '2015-09-10 02:32:19'),
	(50, 3, 35, 0, 'Area de la superficie generada', NULL, '2015-09-10 02:32:51'),
	(51, 3, 35, 0, 'Esfera', NULL, '2015-09-10 02:33:06'),
	(52, 8, 44, 0, 'Repaso de geometria plana', NULL, '2015-09-10 02:35:49'),
	(53, 8, 44, 0, 'Postulado y Teoremas de la congruencia de triangulos', NULL, '2015-09-10 02:36:15'),
	(54, 8, 45, 0, 'Teoremas sobre paralelogramos, trapecios', NULL, '2015-09-10 02:36:43'),
	(55, 8, 45, 0, 'Teorema de Thales', NULL, '2015-09-10 02:37:00'),
	(56, 8, 38, 0, 'Elementos de geometria en el espacio', NULL, '2015-09-10 02:37:20'),
	(57, 8, 38, 0, 'Recta perpendicular a un plano', NULL, '2015-09-10 02:37:44'),
	(58, 3, 39, 0, '', NULL, '2015-09-10 02:37:57'),
	(59, 8, 47, 0, 'Angulo Diedro', NULL, '2015-09-10 02:38:14'),
	(60, 8, 47, 0, 'Angulo poliedro', NULL, '2015-09-10 02:38:34'),
	(61, 8, 48, 0, 'Poliedros', NULL, '2015-09-10 02:38:52'),
	(62, 8, 48, 0, 'Poliedros regulares', NULL, '2015-09-10 02:39:11'),
	(63, 8, 21, 0, 'Prisma', NULL, '2015-09-10 02:39:26'),
	(64, 8, 21, 0, 'Piramide', NULL, '2015-09-10 02:39:42'),
	(65, 8, 50, 0, 'Cilindro', NULL, '2015-09-10 02:39:57'),
	(66, 8, 50, 0, 'Cono', NULL, '2015-09-10 02:40:13'),
	(67, 8, 51, 0, 'Superficie esferica', NULL, '2015-09-10 02:40:35'),
	(68, 8, 51, 0, 'Esfera', NULL, '2015-09-10 02:40:50'),
	(69, 6, 73, 0, 'Nociones basicas', NULL, '2015-09-10 02:44:51'),
	(70, 6, 73, 0, 'Angulos', NULL, '2015-09-10 02:45:13'),
	(71, 6, 74, 0, 'Triangulos', NULL, '2015-09-10 02:45:31'),
	(72, 6, 74, 0, 'Aplicaciones de la congruencia', NULL, '2015-09-10 02:45:53'),
	(73, 6, 75, 0, 'Poligonos', NULL, '2015-09-10 02:46:10'),
	(74, 6, 75, 0, 'Cuadrilateros', NULL, '2015-09-10 02:46:32'),
	(75, 6, 76, 0, 'Circunferencia', NULL, '2015-09-10 02:46:49'),
	(76, 6, 76, 0, 'Angulos en la circunferencia', NULL, '2015-09-10 02:47:09'),
	(77, 6, 77, 0, 'Proporcionalidad', NULL, '2015-09-10 02:47:27'),
	(78, 6, 77, 0, 'Semejanza de triangulos', NULL, '2015-09-10 02:47:47'),
	(79, 6, 78, 0, 'Relaciones metricas en el triangulo rectangulo y obliccuangulo', NULL, '2015-09-10 02:48:43'),
	(80, 6, 78, 0, 'Relaciones metricas en la circunferencia', NULL, '2015-09-10 02:49:04'),
	(81, 6, 79, 0, 'Poligonos regulares', NULL, '2015-09-10 02:49:19'),
	(82, 6, 79, 0, 'Areas de regiones poligonales', NULL, '2015-09-10 02:49:42'),
	(83, 6, 80, 0, 'Areas de regiones cuadrangulares', NULL, '2015-09-10 02:50:05'),
	(84, 6, 80, 0, 'Areas de regiones circulares', NULL, '2015-09-10 02:50:25');
