...
-- Volcando datos para la tabla 20denota.acta: ~0 rows (aproximadamente)
DELETE FROM `acta`;
...
INSERT INTO `acta` (`ACTAP_Codigo`, `USUA_Codigo`, `PROP_Codigo`, `ACTAC_Tipo`, `ACTAC_Fecha`, `ACTAC_Numero`, `ACTAC_Titulo`, `ACTAC_Agenda`, `ACTAC_Detalle`, `ACTAC_Hinicio`, `ACTAC_Hfin`, `ACTAC_FechaModificacion`, `ACTAC_FechaRegistro`) VALUES
	(1, 7, 5, '', '2015-09-21', 1, 'fsdfssfsdf', 'sdf', '', '00:00:00', '09:01:00', '2015-09-21 13:24:31', '2015-09-21 13:00:18');
...
-- Volcando datos para la tabla 20denota.actadetalle: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla 20denota.asignacion: ~1 rows (aproximadamente)
