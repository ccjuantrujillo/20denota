...
CREATE TABLE IF NOT EXISTS `alumno` (
  ...
  CONSTRAINT `FK_cliente_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Volcando datos para la tabla 20denota.alumno: ~8 rows (aproximadamente)
DELETE FROM `alumno`;
...
INSERT INTO `aula` (`AULAP_Codigo`, `COMPP_Codigo`, `LOCP_Codigo`, `AULAC_Nombre`, `AULAC_FechaRegistro`) VALUES
	...
	(11, 1, 2, 'A101', '2015-05-16 03:48:06'),
	(12, 1, 2, 'A102', '2015-05-16 03:48:17'),
	(13, 1, 2, 'A103', '2015-05-16 03:48:30'),
	(14, 1, 2, 'B101', '2015-05-16 03:48:42'),
	(15, 1, 2, 'B102', '2015-05-16 03:48:50'),
	(16, 1, 2, 'B103', '2015-05-16 03:48:59'),
	(17, 1, 2, 'C101', '2015-05-16 03:49:08'),
	(18, 1, 2, 'C102', '2015-05-16 03:49:16'),
	(19, 1, 2, 'C103', '2015-05-16 03:49:24');
...
CREATE TABLE IF NOT EXISTS `curso` (
  ...
  CONSTRAINT `FK_producto_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  CONSTRAINT `FK_empresa_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `menu` (`MENU_Codigo`, `MENU_Codigo_Padre`, `MENU_Descripcion`, `MENU_Comentario`, `MENU_Url`, `MENU_Imagen`, `MENU_FechaRegistro`, `MENU_FechaModificacion`, `MENU_FlagEstado`) VALUES
	...
	(49, 4, 'Carga horaria', NULL, 'index.php/ventas/orden/listar', NULL, '2015-05-16 14:44:52', NULL, '1'),
...
CREATE TABLE IF NOT EXISTS `orden` (
  ...
  CONSTRAINT `FK_orden_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `orden` (`ORDENP_Codigo`, `COMPP_Codigo`, `CLIP_Codigo`, `PROD_Codigo`, `AULAP_Codigo`, `ORDENC_Numero`, `ORDENC_Tiempo`, `ORDENC_Observacion`, `ORDENC_Usuario`, `ORDENC_Password`, `ORDENC_Fecot`, `ORDENC_FechaRegistro`, `ORDENC_FechaModificacion`, `ORDENC_FlagEstado`) VALUES
	(1, 1, 11, 92, 1, 0, 30, '0', 'RPEREZ', '928069', '2015-05-15', '2015-05-15 04:30:29', '2015-05-15 00:00:00', '1');
...
CREATE TABLE IF NOT EXISTS `permiso` (
  ...
  CONSTRAINT `permiso_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla 20denota.permiso: ~10 rows (aproximadamente)
DELETE FROM `permiso`;
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  CONSTRAINT `FK_persona_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla 20denota.persona: ~15 rows (aproximadamente)
DELETE FROM `persona`;
...
CREATE TABLE IF NOT EXISTS `rol` (
  ...
  CONSTRAINT `FK_rol_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `semana` (
  ...
  CONSTRAINT `FK_productoatributo_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `tema` (
  ...
  CONSTRAINT `FK_productoatributodetalle_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `tipoestudio` (
  ...
  CONSTRAINT `FK_tipoestudio_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `tipoproducto` (
  ...
  CONSTRAINT `FK_tipoproducto_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  CONSTRAINT `FK_usuario_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
