...
INSERT INTO `alumno` (`CLIP_Codigo`, `PERSP_Codigo`, `CLIC_FlagEstado`, `CLIC_FechaModificacion`, `CLIC_FechaRegistro`) VALUES
	(2, 63, '1', '2015-05-12 03:38:51', '2014-10-21 02:37:30'),
	(5, 71, '1', '2015-05-09 03:26:31', '2014-10-21 05:23:52'),
	(7, 73, '1', '2015-05-09 03:26:38', '2014-10-28 02:15:16'),
	(9, 80, '1', '2015-05-09 03:44:40', '2014-10-30 07:52:00'),
	(10, 81, '1', '2015-05-09 03:44:31', '2014-10-30 07:53:05'),
	(11, 82, '1', '2014-12-22 16:07:14', '2014-12-19 17:36:43'),
	(16, 87, '1', '2014-12-22 16:03:11', '2014-12-23 02:03:35'),
	(17, 92, '1', '2015-05-09 03:38:59', '2015-05-09 12:39:23'),
	(18, 95, '1', '2015-05-16 21:24:48', '2015-05-16 23:25:12'),
	(19, 96, '1', '2015-07-23 21:34:49', '2015-05-30 05:29:13');
...
-- Volcando datos para la tabla 20denota.conferencia: ~0 rows (aproximadamente)
...
INSERT INTO `empresa` (`EMPRP_Codigo`, `CICLOP_Codigo`, `EMPRC_Ruc`, `EMPRC_RazonSocial`, `EMPRC_Telefono`, `EMPRC_Movil`, `EMPRC_Fax`, `EMPRC_Web`, `EMPRC_Email`, `EMPRC_FlagEstado`, `EMPRC_FechaModificacion`, `EMPRC_FechaRegistro`) VALUES
...
CREATE TABLE IF NOT EXISTS `estudios` (
  ...
  `ESTUDIOC_Estado` char(1) NOT NULL DEFAULT '1',
...
-- Volcando datos para la tabla 20denota.estudios: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla 20denota.estudiosidiomas: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `experiencia` (
  ...
  `EXPERPC_Sector` char(1) DEFAULT NULL,
...
-- Volcando datos para la tabla 20denota.experiencia: ~1 rows (aproximadamente)
DELETE FROM `experiencia`;
/*!40000 ALTER TABLE `experiencia` DISABLE KEYS */;
INSERT INTO `experiencia` (`EXPERP_Codigo`, `PROP_Codigo`, `EXPERPC_Cargo`, `EXPERPC_Empresa`, `EXPERPC_Sector`, `EXPERPC_Curso`, `EXPERPC_FechaInicio`, `EXPERPC_FechaFin`, `EXPERPC_FechaModificacion`, `EXPERPC_FechaRegistro`) VALUES
	(4, 54, 'Jefe de Practica', NULL, NULL, 'Matematica Basica I', '0000-00-00', '0000-00-00', NULL, '2015-10-29 07:59:36');
...
INSERT INTO `matricula` (`ORDENP_Codigo`, `CICLOP_Codigo`, `CLIP_Codigo`, `AULAP_Codigo`, `TIPP_Codigo`, `ORDENC_Observacion`, `ORDENC_Fecot`, `ORDENC_FlagEstado`, `ORDENC_FechaModificacion`, `ORDENC_FechaRegistro`) VALUES
	(1, 2, 11, 13, 5, '0', '2015-05-15', '1', '2015-08-06 00:00:00', '2015-05-15 13:30:53'),
	(2, 2, 16, 15, 5, '0', '2015-05-22', '1', '2015-05-29 00:00:00', '2015-05-23 07:35:12'),
	(4, 2, 5, 14, 5, NULL, '2015-07-24', '1', '2015-07-24 00:00:00', '2015-07-23 17:33:32');
...
INSERT INTO `menu` (`MENU_Codigo`, `MENU_Codigo_Padre`, `MENU_Descripcion`, `MENU_Comentario`, `MENU_Url`, `MENU_Orden`, `MENU_Imagen`, `MENU_FlagEstado`, `MENU_FechaModificacion`, `MENU_FechaRegistro`) VALUES
	...
	(59, 74, 'Aula', NULL, 'index.php/maestros/aula/listar', 6, NULL, '1', NULL, '2015-09-19 22:18:45'),
	(61, 74, 'Local', NULL, 'index.php/maestros/local/listar', 5, NULL, '1', NULL, '2015-09-19 22:18:42'),
	...
	(72, 74, 'Semana', 'Semana', 'index.php/almacen/semana/listar', 4, NULL, '1', NULL, '2015-09-19 22:18:37'),
...
INSERT INTO `persona` (`PERSP_Codigo`, `TIPDOCP_Codigo`, `PERSC_ApellidoPaterno`, `PERSC_ApellidoMaterno`, `PERSC_Nombre`, `PERSC_NumeroDocIdentidad`, `PERSC_Direccion`, `PERSC_Telefono`, `PERSC_Movil`, `PERSC_Fax`, `PERSC_Email`, `PERSC_Domicilio`, `PERSC_Web`, `PERSC_Sexo`, `PERSC_FechaNacimiento`, `PERSC_FlagEstado`, `PERSC_FechaModificacion`, `PERSC_FechaRegistro`) VALUES
	...
	(63, 1, 'GOMEZ  ', 'PEREZ ', 'EDUARDO EDUARDOGF', '45645667', '', '234423', '0', '0', 'eduardo@banich.com', '', '0', '0', '2015-05-03', '1', '2015-08-05 00:27:56', '2011-08-13 09:32:02'),
	(71, 1, 'PEREZ', 'AGUILAR ', 'MARIA', '40091852', 'AV PERU', '456465', '0', '0', 'maria.aguilar@hotmail.com', 'AV PERU', '0', '0', '2014-02-05', '1', '2015-08-05 00:27:56', '2014-10-21 05:23:51'),
	(73, 1, 'RODRIGUEZ', 'MEDRANO', 'ELISEO', '40003256', 'LOS GIRASOLES 4125', '234234/43223434', '0', '0', 'luis.arnaldo@hotmail.com', 'LOS GIRASOLES 4125', '0', '0', '2014-05-11', '1', '2015-08-05 00:27:56', '2014-10-28 02:15:16'),
	(80, 1, 'CANAZAS 2', 'QUISPE', 'RUTHCI̱A', '40091814', 'MZ R LOTE 50 LOS NISPEROS', '34234242', '0', '0', 'martin@trujillo.com', 'MZ R LOTE 50 LOS NISPEROS', '0', '0', '2015-12-01', '1', '2015-08-05 00:27:56', '2014-10-30 07:52:00'),
	(81, 1, 'VARGAS', 'RUIZ', 'ELIZABETH', '21321321', 'MIMCO', 'sdfgdsfgdf', '0', '0', '', 'MIMCO', '0', '0', '0000-00-00', '1', '2015-08-05 00:27:56', '2014-10-30 07:53:05'),
	(82, 1, 'PEREZ', 'GUZMAN', 'ROBERTO', '45645654', 'MZ P LOTE 15 LOS ALAMAMO', '2342342343', '0', '0', 'roberto.perez@hotmail.com', 'MZ P LOTE 15 LOS ALAMAMO', '0', '0', '1992-03-02', '1', '2015-08-05 00:27:56', '2014-12-19 17:36:43'),
	(87, 1, 'PAREDES', 'GONZALES', 'ETHEL', '45645645', 'ASFASFF', '343243', '0', '0', 'ethel.gonzales@hotmail.com', 'ASFASFF', '0', '0', '1997-12-02', '1', '2015-08-05 00:27:56', '2014-12-23 02:03:35'),
	...
	(92, 1, 'PEREZ DOVAL', 'SANDOVAL', 'DALEANA', '12341234', 'MZ R LOTE 50 LOS NISPEROS', '34324234', '0', '0', 'miriam@hotmail.com', 'MZ R LOTE 50 LOS NISPEROS', '0', '0', '2015-04-22', '1', '2015-08-05 00:27:56', '2015-05-09 12:39:23'),
	...
	(95, 1, 'PEREZ', 'PEREZ', 'GUSTAVO', '12341234', 'MZ R LOTE ', '342344', '0', '0', 'gusta.perez@gmail.com', 'MZ R LOTE ', '0', '0', '2015-05-12', '1', '2015-08-05 00:27:56', '2015-05-16 23:25:12'),
	(96, 1, 'AAA', 'BBBB', 'CCCCOCO', '41234321', 'WER', '34234', '0', '0', '', 'WER', '0', '0', '2015-05-26', '1', '2015-08-05 00:27:56', '2015-05-30 05:29:13'),
	...
	(161, 0, 'Zamudio', 'Peves', 'Jose Fernando', '', '', '', '', '0', '', '', '0', '1', '0000-00-00', '1', NULL, '2015-10-16 09:46:43'),
	...
	(177, 0, 'Alania', 'Lazo', 'Nelly', '', '', '', '', '0', '', '', '0', '1', '0000-00-00', '1', NULL, '2015-10-16 12:36:00'),
...
INSERT INTO `profesor` (`PROP_Codigo`, `PROD_Codigo`, `PERSP_Codigo`, `PROC_FlagCoordinador`, `PROC_FlagEstado`, `PROC_FechaModificacion`, `PROC_FechaRegistro`) VALUES
	...
	(36, 95, 160, 2, '1', '2015-10-16 16:46:20', '2015-10-16 09:46:20'),
	(37, 95, 161, 2, '1', '2015-10-16 16:46:43', '2015-10-16 09:46:43'),
	...
	(53, 98, 177, 2, '1', '2015-10-16 19:36:00', '2015-10-16 12:36:00'),
...
-- Volcando datos para la tabla 20denota.sociedad: ~0 rows (aproximadamente)
...
INSERT INTO `vigilancia` (`VIGILAP_Codigo`, `PROP_Codigo`, `VIGILAC_Nombre`, `VIGILAC_Descripcion`, `VIGILAC_Fecha`, `VIGILAC_FechaModificacion`, `VIGILAC_FechaRegistro`) VALUES
	...
	(5, 54, 'dfg', 'sdfgsfdgsfg', '2015-10-24', NULL, '2015-10-24 08:13:40'),
	(7, 50, 'Examenes parciales ultimos', '2015', '2015-10-26', NULL, '2015-10-26 00:50:06');
...
INSERT INTO `vigilanciadetalle` (`VIGILADETP_Codigo`, `VIGILAP_Codigo`, `PROD_Codigo`, `PROP_Codigo`, `VIGILADETC_FechaModificacion`, `VIGILADETC_FechaRegistro`) VALUES
	(1, 5, 93, 11, NULL, '2015-10-24 08:13:40'),
	(2, 7, 5, 10, NULL, '2015-10-26 00:50:06'),
	(3, 7, 93, 5, NULL, '2015-10-26 00:50:06'),
	(4, 7, 97, 51, NULL, '2015-10-26 00:50:06'),
	...
	(11, 7, 5, 8, NULL, '2015-10-26 06:51:40');
