...
INSERT INTO `ciclo` (`CICLOP_Codigo`, `COMPC_Nombre`, `CICC_FECHA_INICIO`, `CICC_FECHA_FIN`, `CICC_DESCRIPCION`, `COMPC_Tipo`, `COMPC_FlagEstado`) VALUES
	(1, 'ADMISION 2015-2', '0000-00-00', '1990-05-11', 'CICLO DE INICIO DEL A̱O', 2, 1),
	(2, 'ADMISION 2016-1', '2015-05-06', '2015-10-25', 'CICLO DE FIN DE A̱O', 1, 1);
...
CREATE TABLE IF NOT EXISTS `tipoestudio` (
  ...
  KEY `FK_tipoestudio_ciclo` (`CICLOP_Codigo`),
  CONSTRAINT `FK_tipoestudio_ciclo` FOREIGN KEY (`CICLOP_Codigo`) REFERENCES `ciclo` (`CICLOP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
