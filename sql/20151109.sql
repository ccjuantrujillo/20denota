...
INSERT INTO `estudiosidiomas` (`ESTIDIOMP_Codigo`, `PROP_Codigo`, `IDIOMP_Codigo`, `ESTIDIOMC_Descripcion`, `ESTIDIOMC_Nivel`, `ESTIDIOMC_FechaInicio`, `ESTIDIOMC_FechaFin`, `ESTIDIOMC_FechaModificacion`, `ESTIDIOMC_FechaRegistro`) VALUES
	(1, 54, 1, 'afadsfsdf', '1', '0000-00-00', '0000-00-00', NULL, '2015-11-06 12:03:27'),
	(2, 54, 4, '0', '2', '1953-03-00', '1953-03-00', NULL, '2015-11-09 08:21:48'),
	(3, 54, 5, '0', '3', '1954-03-00', '1954-03-00', NULL, '2015-11-09 08:27:00'),
	(4, 54, 2, '0', '1', '1952-05-00', '1952-05-00', NULL, '2015-11-09 08:27:54');
...
INSERT INTO `experiencia` (`EXPERP_Codigo`, `PROP_Codigo`, `EXPERPC_Cargo`, `EXPERPC_Empresa`, `EXPERPC_Curso`, `EXPERPC_FechaInicio`, `EXPERPC_FechaFin`, `EXPERPC_FechaModificacion`, `EXPERPC_FechaRegistro`) VALUES
	(4, 54, 'Jefe de Practica', NULL, 'Matematica Basica I', '0000-00-00', '0000-00-00', NULL, '2015-10-29 07:59:36'),
	(7, 54, 'fasdfasdf', 'asdfasd', 'asdfasdf', '1954-03-00', '1954-03-00', NULL, '2015-11-09 06:42:13'),
	(8, 54, 'Jefe de presupuestos', 'CAME S.A.', 'Lineas de transmision', '1953-05-00', '1953-05-00', NULL, '2015-11-09 06:43:20'),
	(9, 54, 'Sistemas analista', 'MIMCO S.A.C.', 'Sap', '1954-05-00', '1954-05-00', NULL, '2015-11-09 06:47:40'),
	(10, 54, 'sdfgsdf', 'dsfg', 'gsdfgsdfg', '1952-06-00', '1952-06-00', NULL, '2015-11-09 06:59:02'),
	(11, 54, 'Analista funcional', 'COSAPI DATA', 'Primero tu', '1955-03-00', '1955-03-00', NULL, '2015-11-09 07:05:35'),
	(12, 54, 'Profesor auxiliar', 'UNIVERSIDAD NACIONAL DE INGENIERIA', 'Matematica basicas II', '1953-04-00', '1953-04-00', NULL, '2015-11-09 07:07:37'),
	(13, 54, 'Profesor auxiliar', 'UNIVERSIDAD', 'Matematica basicas II', '1953-04-00', '1953-04-00', NULL, '2015-11-09 07:07:51'),
	(14, 54, 'Dibujante', 'Construcciones metalicas', 'Autocad', '1955-05-00', '1955-05-00', NULL, '2015-11-09 07:08:38'),
	(15, 53, 'asdf', 'came', 'asdf', '1954-04-00', '1954-04-00', NULL, '2015-11-09 08:29:56'),
	(16, 53, 'asdf', 'asdf', 'asdfas', '1955-03-00', '1955-03-00', NULL, '2015-11-09 08:30:05');
...
-- Volcando datos para la tabla 20denota.profesorsociedad: ~2 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `trabajo` (
  ...
  `TRABAJC_Sector` varchar(150) DEFAULT NULL,
  `TRABAJC_FechaInicio` date DEFAULT NULL,
  `TRABAJC_FechaFin` date DEFAULT NULL,
...
-- Volcando datos para la tabla 20denota.trabajo: ~1 rows (aproximadamente)
DELETE FROM `trabajo`;
/*!40000 ALTER TABLE `trabajo` DISABLE KEYS */;
INSERT INTO `trabajo` (`TRABAJP_Codigo`, `PROP_Codigo`, `TRABAJC_Descripcion`, `TRABAJC_Sector`, `TRABAJC_FechaInicio`, `TRABAJC_FechaFin`, `TRABAJC_FechaModificacion`, `TRABAJC_FechaRegistro`) VALUES
	(1, 54, 'sasadfafsadf', NULL, NULL, NULL, NULL, '2015-11-06 12:47:55');
