...
CREATE TABLE IF NOT EXISTS `estudios` (
  ...
  `ESTUDIOC_FechaModificacion` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `grado` (
  ...
  `GRADOC_FechaModificacion` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `vigilanciadetalle` (
  ...
  `PROD_Codigo` int(11) NOT NULL DEFAULT '0',
  `PROP_Codigo` int(11) NOT NULL DEFAULT '0',
  `VIGILADETC_FechaModificacion` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
