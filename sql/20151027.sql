...
CREATE TABLE IF NOT EXISTS `acta` (
  ...
  `ACTAC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `asignacion` (
  ...
  `ASIGC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `asignaciondetalle` (
  ...
  `ASIGDETC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `cursociclo` (
  ...
  `CURSOCIC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `cursotipoestudio` (
  ...
  `CURSOTIPOC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `estudios` (
  ...
  `ESTUDIOC_Tipo` char(1) DEFAULT NULL COMMENT '1:Experiencia,2:Educacion,3:Idiomas,4:Conferencias,5:Sociedades Cientificas,6:Profesional',
  `ESTUDIOC_FechaInicio` date DEFAULT NULL,
  `ESTUDIOC_FechaFin` date DEFAULT NULL,
  `ESTUDIOC_FechaModificacion` datetime,
...
INSERT INTO `estudios` (`ESTUDIOP_Codigo`, `PROP_Codigo`, `UNIVP_Codigo`, `GRADOP_Codigo`, `ESTUDIOC_Descripcion`, `ESTUDIOC_Estado`, `ESTUDIOC_Tipo`, `ESTUDIOC_FechaInicio`, `ESTUDIOC_FechaFin`, `ESTUDIOC_FechaModificacion`, `ESTUDIOC_FechaRegistro`) VALUES
	(1, 54, 17, 1, 'primera carrera', '1', '1', '0000-00-00', '0000-00-00', '2015-10-26 11:05:05', '2015-10-26 10:43:50'),
	(2, 54, 15, 5, 'segunda carrera', '1', '1', '0000-00-00', '0000-00-00', '2015-10-26 11:05:08', '2015-10-26 10:44:04'),
	(3, 54, 9, 3, 'tercera carrera', '1', '1', '0000-00-00', '0000-00-00', '2015-10-26 11:05:11', '2015-10-26 10:44:17');
...
CREATE TABLE IF NOT EXISTS `grado` (
  ...
  `GRADOC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  `PERSC_FechaModificacion` datetime,
...
-- Volcando datos para la tabla 20denota.persona: ~61 rows (aproximadamente)
DELETE FROM `persona`;
...
-- Volcando datos para la tabla 20denota.rol: ~4 rows (aproximadamente)
DELETE FROM `rol`;
...
CREATE TABLE IF NOT EXISTS `semana` (
  ...
  `PRODATRIB_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `tarea` (
  ...
  `TAREAC_FechaModificacion` datetime,
...
INSERT INTO `tarea` (`TAREAP_Codigo`, `USUA_Codigo`, `PROP_Codigo`, `CICLOP_Codigo`, `TIPOTAREAP_Codigo`, `TAREAC_Nombre`, `TAREAC_Descripcion`, `TAREAC_Fecha`, `TAREAC_FechaEntrega`, `TAREAC_Numero`, `TAREAC_FechaModificacion`, `TAREAC_FechaRegistro`) VALUES
	...
	(2, 7, 50, 1, 1, 'Problemas de fisica', 'adfasdf', '2015-09-29', '2015-09-17', 22, '2015-10-24 07:38:11', '2015-09-29 15:00:40'),
	(3, 7, 8, 1, 1, 'Mi casa es tu cas', 'asdfasdfsdf', '2015-09-29', '2015-09-23', 20, '2015-10-24 07:38:47', '2015-09-29 15:01:06'),
	...
	(6, 7, 7, 1, 3, '1111111', 'wertwert', '2015-10-10', '2015-10-13', 333, '2015-10-22 00:30:24', '2015-10-09 18:21:35'),
	(7, 7, 54, 1, 3, 'dsfdasf', 'afsdasdfsadf', '2015-10-22', '2015-10-07', 3, NULL, '2015-10-22 00:25:35'),
	(8, 7, 8, 1, 3, 'ola a todos', 'adsf', '2015-10-24', '2015-10-07', 3, NULL, '2015-10-24 07:34:39');
...
CREATE TABLE IF NOT EXISTS `tareadetalle` (
  ...
  `TAREADETC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `tareo` (
  ...
  `TAREOC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `tema` (
  ...
  `TEMAC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `tipoestudiociclo` (
  ...
  `TIPCICLOC_FechaRegistro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `vigilancia` (
  ...
  `VIGILAC_FechaModificacion` datetime,
...
CREATE TABLE IF NOT EXISTS `vigilanciadetalle` (
  ...
  `PROD_Codigo` int(11) NOT NULL DEFAULT '0',
  `PROP_Codigo` int(11) NOT NULL DEFAULT '0',
  `VIGILADETC_FechaModificacion` datetime,
