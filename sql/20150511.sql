...
-- Volcando datos para la tabla 20denota.persona: ~14 rows (aproximadamente)
DELETE FROM `persona`;
...
INSERT INTO `persona` (`PERSP_Codigo`, `COMPP_Codigo`, `PERSC_ApellidoPaterno`, `PERSC_ApellidoMaterno`, `PERSC_Nombre`, `PERSC_NumeroDocIdentidad`, `PERSC_Direccion`, `PERSC_Telefono`, `PERSC_Movil`, `PERSC_Fax`, `PERSC_Email`, `PERSC_Domicilio`, `PERSC_Web`, `PERSC_Sexo`, `PERSC_FechaNacimiento`, `PERSC_FechaRegistro`, `PERSC_FechaModificacion`, `PERSC_FlagEstado`) VALUES
	...
	(91, 1, '', '', '', '', '', '', '0', '0', '', '', '0', '0', '0000-00-00', '2015-04-04 06:07:35', NULL, '1'),
...
-- Volcando datos para la tabla 20denota.profesor: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla 20denota.semana: ~0 rows (aproximadamente)
DELETE FROM `semana`;
...
-- Volcando datos para la tabla 20denota.tema: ~3 rows (aproximadamente)
DELETE FROM `tema`;
