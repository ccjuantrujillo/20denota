...
<div class="contenidotabla" >
    ...
    <div id="cabecera" style="height: 450px;">
        <table style="background-color: #f4f7ff">
            ...
            <tr>
              <td bgcolor="#d5e2f2">Tipo</td>
              <td class="formss"><?php echo $seltipo;?></td>
            </tr>               
            <tr>
              <td bgcolor="#d5e2f2">Profesor</td>
              <td class="formss">
