...
CREATE TABLE IF NOT EXISTS `alumno` (
  ...
  CONSTRAINT `FK_cliente_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `alumno` (`CLIP_Codigo`, `COMPP_Codigo`, `PERSP_Codigo`, `CLIC_FechaRegistro`, `CLIC_FechaModificacion`, `CLIC_FlagEstado`) VALUES
	(2, 1, 63, '2014-10-20 21:37:30', '2015-05-12 03:38:51', '1'),
	(5, 1, 71, '2014-10-21 00:23:52', '2015-05-09 03:26:31', '1'),
	(7, 1, 73, '2014-10-27 21:15:16', '2015-05-09 03:26:38', '1'),
	(9, 1, 80, '2014-10-30 02:52:00', '2015-05-09 03:44:40', '1'),
	(10, 1, 81, '2014-10-30 02:53:05', '2015-05-09 03:44:31', '1'),
	(11, 1, 82, '2014-12-19 12:36:43', '2014-12-22 16:07:14', '1'),
	(16, 1, 87, '2014-12-22 21:03:35', '2014-12-22 16:03:11', '1'),
	(17, 1, 92, '2015-05-09 07:39:23', '2015-05-09 03:38:59', '1'),
	(18, 1, 95, '2015-05-16 18:25:12', '2015-05-16 21:24:48', '1'),
	(19, 1, 96, '2015-05-30 00:29:13', '2015-05-29 20:29:13', '1');
...
CREATE TABLE IF NOT EXISTS `asignacion` (
  ...
  CONSTRAINT `FK_asignacion_ciclo` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `asignacion` (`ASIGP_Codigo`, `AULAP_Codigo`, `PROP_Codigo`, `COMPP_Codigo`, `TIPP_Codigo`, `ASIGC_Descripcion`, `ASIGC_Fecha`, `ASIGC_FechaRegistro`, `ASIGC_FechaModificacion`, `ASIGC_FlagEstado`) VALUES
	(1, 5, 5, 1, 1, '0', '2015-05-29 00:00:00', '2015-05-30 01:44:26', '2015-05-29 00:00:00', '2'),
	(2, 5, 5, 1, 2, '0', '2015-05-29 00:00:00', '2015-05-30 02:24:50', '2015-05-29 00:00:00', '2');
...
INSERT INTO `aula` (`AULAP_Codigo`, `LOCP_Codigo`, `COMPP_Codigo`, `AULAC_Nombre`, `AULAC_FechaRegistro`) VALUES
	(1, 1, 1, 'D101', '2015-05-16 07:46:43'),
	(2, 1, 1, 'D102', '2015-05-16 07:46:58'),
	(3, 1, 1, 'D103', '2015-05-16 07:47:11'),
	(4, 1, 1, 'D104', '2015-05-16 07:47:20'),
	(5, 1, 1, 'D201', '2015-05-16 07:47:30'),
	(6, 1, 1, 'D202', '2015-05-16 07:47:40'),
	(7, 1, 1, 'D203', '2015-05-16 07:47:49'),
	(8, 1, 1, 'D204', '2015-05-16 07:47:58'),
	(9, 1, 1, 'D205', '2015-05-16 07:48:06'),
	(10, 1, 1, 'D206', '2015-05-16 07:48:14'),
	(11, 2, 1, 'A101', '2015-05-16 07:48:30'),
	(12, 2, 1, 'A102', '2015-05-16 07:48:41'),
	(13, 2, 1, 'A103', '2015-05-16 07:48:54'),
	(14, 2, 1, 'B101', '2015-05-16 07:49:06'),
	(15, 2, 1, 'B102', '2015-05-16 07:49:14'),
	(16, 2, 1, 'B103', '2015-05-16 07:49:23'),
	(17, 2, 1, 'C101', '2015-05-16 07:49:32'),
	(18, 2, 1, 'C102', '2015-05-16 07:49:40'),
	(19, 2, 1, 'C103', '2015-05-16 07:49:48');
...
-- Volcando estructura para tabla 20denota.ciclo_
...
-- Volcando datos para la tabla 20denota.ciclo_: ~2 rows (aproximadamente)
DELETE FROM `ciclo_`;
/*!40000 ALTER TABLE `ciclo_` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ciclo_` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `curso` (
  ...
  CONSTRAINT `FK_producto_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `curso` (`PROD_Codigo`, `COMPP_Codigo`, `TIPPROD_Codigo`, `PROD_Nombre`, `PROD_DescripcionBreve`, `PROD_EspecificacionPDF`, `PROD_Comentario`, `PROD_Cantidad`, `PROD_Intentos`, `PROD_Tiempo`, `PROD_TiempoExamen`, `PROD_Puntaje`, `PROD_Imagen`, `PROD_Silabus`, `PROD_FechaRegistro`, `PROD_FechaModificacion`, `PROD_FlagEstado`) VALUES
	(5, 1, 1, 'TRIGONOMETRIA', 'SED UT PERSPICIATIS UNDE OMNIS ISTE NATUS ERROR SIT VOLUPTATEM ACCUSANTIUM DOLOREMQUE LAUDANTIUM, TOTAM REM APERIAM. ', '', '', 88, 3, 2, 5, 14, 'erp.png', 'capitulo06.pdf', '2011-01-18 02:20:19', '2015-03-04 23:04:14', '1'),
	(92, 1, 1, 'FISICA', 'EDWARD', '', '', 3, 5, 5, 30, 14, NULL, NULL, '2015-03-25 13:01:35', '2015-05-09 03:55:51', '1'),
	(93, 1, 1, 'GEOMETRIA', 'EDWARD', '', '', 4, 5, 5, 30, 14, NULL, NULL, '2015-03-25 13:02:55', '2015-05-09 03:55:42', '1');
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  CONSTRAINT `FK_empresa_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `empresa` (`EMPRP_Codigo`, `COMPP_Codigo`, `EMPRC_Ruc`, `EMPRC_RazonSocial`, `EMPRC_Telefono`, `EMPRC_Movil`, `EMPRC_Fax`, `EMPRC_Web`, `EMPRC_Email`, `EMPRC_FechaRegistro`, `EMPRC_FechaModificacion`, `EMPRC_FlagEstado`) VALUES
	(0, 1, NULL, 'EMPRESA NO REGISTRADA', NULL, NULL, NULL, NULL, NULL, '2010-12-16 23:34:56', NULL, '1'),
	(1, 1, '11111111111', 'W', '', '', '', '', '', '2011-01-09 10:30:59', NULL, '0');
...
INSERT INTO `local` (`LOCP_Codigo`, `LOCC_Nombre`, `LOCC_Direccion`, `LOCC_Telefono`, `LOCC_FechaRegistro`) VALUES
	(1, 'Sede Sucre', '', '', '2015-05-16 07:45:22'),
	(2, 'Sede Javier Prado', '', '', '2015-05-16 07:45:32');
...
CREATE TABLE IF NOT EXISTS `matricula` (
  ...
  CONSTRAINT `FK_matricula_ciclo` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `matricula` (`ORDENP_Codigo`, `COMPP_Codigo`, `CLIP_Codigo`, `AULAP_Codigo`, `TIPP_Codigo`, `ORDENC_Observacion`, `ORDENC_Fecot`, `ORDENC_FechaRegistro`, `ORDENC_FechaModificacion`, `ORDENC_FlagEstado`) VALUES
	(1, 1, 11, 1, 1, '0', '2015-05-15', '2015-05-15 08:30:53', '2015-05-22 00:00:00', '2'),
	(2, 2, 16, 15, 5, '0', '2015-05-22', '2015-05-23 02:35:12', '2015-05-29 00:00:00', '1'),
	(3, 2, 10, 5, 5, NULL, '2015-05-22', '2015-05-23 02:58:30', '2015-05-22 00:00:00', '2');
...
-- Volcando datos para la tabla 20denota.menu: ~15 rows (aproximadamente)
DELETE FROM `menu`;
...
-- Volcando estructura para tabla 20denota.menu_
...
-- Volcando datos para la tabla 20denota.menu_: ~11 rows (aproximadamente)
DELETE FROM `menu_`;
/*!40000 ALTER TABLE `menu_` DISABLE KEYS */;
INSERT INTO `menu_` (`MENU_Codigo`, `MENU_Codigo_Padre`, `MENU_Descripcion`, `MENU_Comentario`, `MENU_Url`, `MENU_Imagen`, `MENU_FechaRegistro`, `MENU_FechaModificacion`, `MENU_FlagEstado`) VALUES
	(2, 3, 'Alumnos', 'Aquí se podrán subir las imágenes o aniamciones que serán contenidas en la marquesina', 'index.php/ventas/alumno/listar', 'alumno.jpg', '2015-03-14 07:47:50', NULL, '1'),
	(3, 1, 'MANTENIMIENTOS', 'Aquí se podrán subir las imágenes tipo preview para el menú que contenga un enlace.', 'index.php/almacen/curso/listar', 'libros.jpg', '2015-03-25 12:26:34', NULL, '1'),
	(4, 1, 'OPERACIONES', 'Aquí se subirán la imagen del catálogo de la campaña actual.', 'index.php/ventas/orden/listar', 'matri.jpg', '2015-02-27 17:36:51', NULL, '1'),
	(22, 3, 'Cursos', NULL, 'index.php/almacen/curso/listar', '', '2015-03-25 12:27:41', NULL, '1'),
	(48, 4, 'Matricula', NULL, 'index.php/ventas/matricula/listar', 'matri.jpg', '2015-05-17 04:11:09', NULL, '1'),
	(49, 4, 'Carga horaria', NULL, 'index.php/ventas/asignacion/listar', NULL, '2015-05-17 04:11:20', NULL, '1'),
	(52, 3, 'Documentos', NULL, 'index.php/inicio/principal', NULL, '2015-03-03 08:39:21', NULL, '1'),
	(53, 3, 'Profesor', 'Tabla de Profesores', 'index.php/ventas/profesor/listar', NULL, '2015-03-14 08:18:28', NULL, '1'),
	(55, 3, 'Ejemplo 1', 'Ejemplo 1', 'index.php/almacen/curso/listar', NULL, '2015-04-02 14:40:30', NULL, '1'),
	(56, 1, 'Ejemplo 3', 'Ejemplo 3', 'index.php/almacen/curso/listar', NULL, '2015-04-02 14:58:48', NULL, '1'),
	(57, 56, 'Ejemplo 5', 'Ejemplo 5', 'Ejemplo5', NULL, '2015-04-02 15:18:57', NULL, '1');
/*!40000 ALTER TABLE `menu_` ENABLE KEYS */;
...
-- Volcando datos para la tabla 20denota.permiso: ~13 rows (aproximadamente)
DELETE FROM `permiso`;
...
-- Volcando estructura para tabla 20denota.permiso_
CREATE TABLE IF NOT EXISTS `permiso_` (
  ...
  KEY `FK_cji_permiso_cji_menu` (`MENU_Codigo`),
  KEY `COMPP_Codigo` (`COMPP_Codigo`),
  CONSTRAINT `FK_cji_permiso_cji_menu` FOREIGN KEY (`MENU_Codigo`) REFERENCES `menu_` (`MENU_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `permiso_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla 20denota.permiso_: ~9 rows (aproximadamente)
DELETE FROM `permiso_`;
/*!40000 ALTER TABLE `permiso_` DISABLE KEYS */;
INSERT INTO `permiso_` (`PERM_Codigo`, `COMPP_Codigo`, `ROL_Codigo`, `MENU_Codigo`, `PERM_FlagEstado`) VALUES
	...
	(39, 1, 4, 53, '1'),
	(45, 1, 4, 57, '1');
/*!40000 ALTER TABLE `permiso_` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  CONSTRAINT `FK_persona_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla 20denota.persona: ~18 rows (aproximadamente)
DELETE FROM `persona`;
...
INSERT INTO `persona` (`PERSP_Codigo`, `COMPP_Codigo`, `PERSC_ApellidoPaterno`, `PERSC_ApellidoMaterno`, `PERSC_Nombre`, `PERSC_NumeroDocIdentidad`, `PERSC_Direccion`, `PERSC_Telefono`, `PERSC_Movil`, `PERSC_Fax`, `PERSC_Email`, `PERSC_Domicilio`, `PERSC_Web`, `PERSC_Sexo`, `PERSC_FechaNacimiento`, `PERSC_FechaRegistro`, `PERSC_FechaModificacion`, `PERSC_FlagEstado`) VALUES
	(1, 1, 'TRUJILLO', 'BUSTAMANTE', 'MARTIN', '23442342', 'SGSGSDFGSGSDG', '435345345', '345435', '5345435', 'ewtrewtertter', 'SGSGSDFGSGSDG', 'dgsgsgd', '', '1980-05-01', '2010-12-29 15:15:19', NULL, '1'),
	(63, 1, 'GOMEZ  ', 'PEREZ ', 'EDUARDO EDUARDOGF', '45645667', '', '234423', '0', '0', 'eduardo@banich.com', '', '0', '0', '2015-05-03', '2011-08-13 04:32:02', NULL, '1'),
	(71, 1, 'PEREZ', 'AGUILAR ', 'MARIA', '40091852', 'AV PERU', '456465', '0', '0', 'maria.aguilar@hotmail.com', 'AV PERU', '0', '0', '2014-02-05', '2014-10-21 00:23:51', NULL, '1'),
	(73, 1, 'RODRIGUEZ', 'MEDRANO', 'ELISEO', '40003256', 'LOS GIRASOLES 4125', '234234/43223434', '0', '0', 'luis.arnaldo@hotmail.com', 'LOS GIRASOLES 4125', '0', '0', '2014-05-11', '2014-10-27 21:15:16', NULL, '1'),
	(80, 1, 'CANAZAS 2', 'QUISPE', 'RUTHCIÃ±A', '40091814', 'MZ R LOTE 50 LOS NISPEROS', '34234242', '0', '0', 'martin@trujillo.com', 'MZ R LOTE 50 LOS NISPEROS', '0', '0', '2015-12-01', '2014-10-30 02:52:00', NULL, '1'),
	(81, 1, 'VARGAS', 'RUIZ', 'ELIZABETH', '21321321', 'MIMCO', 'sdfgdsfgdf', '0', '0', '', 'MIMCO', '0', '0', '0000-00-00', '2014-10-30 02:53:05', NULL, '1'),
	(82, 1, 'PEREZ', 'GUZMAN', 'ROBERTO', '45645654', 'MZ P LOTE 15 LOS ALAMAMO', '2342342343', '0', '0', 'roberto.perez@hotmail.com', 'MZ P LOTE 15 LOS ALAMAMO', '0', '0', '1992-03-02', '2014-12-19 12:36:43', NULL, '1'),
	(87, 1, 'PAREDES', 'GONZALES', 'ETHEL', '45645645', 'ASFASFF', '343243', '0', '0', 'ethel.gonzales@hotmail.com', 'ASFASFF', '0', '0', '1997-12-02', '2014-12-22 21:03:35', NULL, '1'),
	(88, 1, 'FIGUEROA', 'MALDONADO', 'EDWARD', '40772496', 'AV. ABANCAY 986 S.M.P.', '5681903', '0', '0', 'edward.figueroa.ing@gmail.com', 'AV. ABANCAY 986 S.M.P.', '0', '0', '1980-03-19', '2015-03-21 06:32:00', NULL, '1'),
	(89, 1, 'FIGUEROA', 'MALDONADO', 'EDWARD', '40772496', 'ABANCAY 986 SMP', '5681903', '0', '0', 'edward.figueroa.ing@gmail.com', 'ABANCAY 986 SMP', '0', '0', '2015-03-18', '2015-03-21 06:32:58', NULL, '1'),
	(90, 1, 'FIGUEROA', 'MALDONADO', 'EDWARD', '40772496', 'AV. ABANCAY 986 SMP', '5681903', '0', '0', 'edward.figueroa.ing@gmail.com', 'AV. ABANCAY 986 SMP', '0', '0', '2015-03-11', '2015-03-21 06:36:29', NULL, '1'),
	(91, 1, 'FIGUERO', 'MALDONADO', 'EDWARD', '32424234', 'SAN MARTIN DE PORRES', '21231123', '0', '0', 'edward.figueroa@gmail.com', 'SAN MARTIN DE PORRES', '0', '0', '2015-05-26', '2015-04-04 10:07:59', NULL, '1'),
	(92, 1, 'PEREZ DOVAL', 'SANDOVAL', 'DALEANA', '12341234', 'MZ R LOTE 50 LOS NISPEROS', '34324234', '0', '0', 'miriam@hotmail.com', 'MZ R LOTE 50 LOS NISPEROS', '0', '0', '2015-04-22', '2015-05-09 07:39:23', NULL, '1'),
	(93, 1, 'VASQUEZ', 'DOMINGUEZ', 'RIQUELMER', '32423423', 'LIMA', '234234', '0', '0', '', 'LIMA', '0', '0', '2015-05-20', '2015-05-16 07:23:59', NULL, '1'),
	(94, 1, 'AREVALO', 'VILLANUEVA', 'MANUEL', '234234', '', '324234324', '0', '0', '', '', '0', '0', '0000-00-00', '2015-05-16 07:25:47', NULL, '1'),
	(95, 1, 'PEREZ', 'PEREZ', 'GUSTAVO', '12341234', 'MZ R LOTE ', '342344', '0', '0', 'gusta.perez@gmail.com', 'MZ R LOTE ', '0', '0', '2015-05-12', '2015-05-16 18:25:12', NULL, '1'),
	(96, 1, 'AAA', 'BBBB', 'CCCC', '41234321', 'WER', '34234', '0', '0', '', 'WER', '0', '0', '2015-05-25', '2015-05-30 00:29:13', NULL, '1'),
	(97, 1, 'ALMORA', 'RIVAS', 'ENRIQUE', '23452345', '', '6598118', '0', '0', 'enalry25@hotmail.com', '', '0', '0', '2015-05-25', '2015-05-30 00:31:56', NULL, '1');
...
-- Volcando datos para la tabla 20denota.profesor: ~5 rows (aproximadamente)
...
INSERT INTO `profesor` (`PROP_Codigo`, `COMPP_Codigo`, `PROD_Codigo`, `PERSP_Codigo`, `ROL_Codigo`, `PROC_FechaModificacion`, `PROC_FechaRegistro`, `PROC_FlagEstado`) VALUES
	(4, 0, 92, 90, 5, '2015-03-21', '2015-03-21 04:00:24', '1'),
	(5, 1, 93, 91, 7, '2015-05-16', '2015-05-16 04:00:24', '1'),
	(6, 1, 93, 93, 4, '2015-05-16', '2015-05-16 07:24:00', '1'),
	(7, 1, 93, 94, 5, '2015-05-16', '2015-05-16 07:25:47', '1'),
	(8, 1, 5, 97, 1, '2015-05-29', '2015-05-30 00:31:56', '1');
...
CREATE TABLE IF NOT EXISTS `rol` (
  ...
  CONSTRAINT `FK_rol_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `rol` (`ROL_Codigo`, `COMPP_Codigo`, `ROL_Descripcion`, `ROL_FechaRegistro`, `ROL_FechaModificacion`, `ROL_FlagEstado`) VALUES
	(1, 1, 'Usuario', '2014-10-12 21:09:54', NULL, '1'),
	(4, 1, 'Administrador', '2014-10-12 21:09:30', NULL, '1'),
	(5, 1, 'Profesor', '2015-05-16 06:08:48', NULL, '1'),
	(6, 1, 'Coordinador de plana', '2015-05-16 06:09:41', NULL, '1'),
	(7, 1, 'Coordinador general', '2015-05-16 06:09:53', NULL, '1');
...
CREATE TABLE IF NOT EXISTS `semana` (
  ...
  CONSTRAINT `FK_productoatributo_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `semana` (`PRODATRIB_Codigo`, `PROD_Codigo`, `COMPP_Codigo`, `PRODATRIB_Nombre`, `PRODATRIB_Descripcion`, `PRODATRIB_Preguntas`, `PRODATRIB_Puntaje`, `PRODATRIB_Vimeo`, `PRODATRIB_NroIntentos`, `PRODATRIB_FechaModificacion`, `PRODATRIB_FechaRegistro`) VALUES
	(16, 93, 1, 'SEMANA 01', 'ASDF', 5, 0, 'http://vimeo.com/92884359', 1, NULL, '2014-10-12 21:41:07'),
	(17, 93, 1, 'SEMANA 02', '', 5, 0, '', 0, NULL, '2015-05-12 06:54:09'),
	(18, 93, 1, 'SEMANA 03', '', 5, 0, '', 0, NULL, '2015-05-12 06:54:27'),
	(19, 93, 1, 'SEMANA 05', '', 5, 0, '', 0, NULL, '2015-05-12 06:54:40'),
	(20, 93, 1, 'SEMANA 04', '', 5, 0, '', 0, NULL, '2015-05-12 06:54:57'),
	(21, 93, 1, 'SEMANA 06', '', 5, 0, '', 0, NULL, '2015-05-12 06:55:15'),
	(22, 93, 1, 'SEMANA 07', '', 5, 0, '', 0, NULL, '2015-05-12 06:56:38'),
	(23, 93, 1, 'SEMANA 08', '', 5, 0, '', 0, NULL, '2015-05-12 06:57:38'),
	(24, 93, 1, 'SEMANA 09', '', 5, 0, '', 0, NULL, '2015-05-12 06:57:50'),
	(25, 93, 1, 'SEMANA 10', '', 5, 0, '', 0, NULL, '2015-05-12 06:58:00'),
	(26, 93, 1, 'SEMANA 11', '', 5, 0, '', 0, NULL, '2015-05-12 06:58:19'),
	(27, 93, 1, 'SEMANA 12', '', 5, 0, '', 0, NULL, '2015-05-12 06:58:35'),
	(28, 93, 1, 'SEMANA 13', '', 5, 0, '', 0, NULL, '2015-05-12 06:58:46'),
	(29, 93, 1, 'SEMANA 14', '', 5, 0, '', 0, NULL, '2015-05-12 06:59:07'),
	(30, 93, 1, 'SEMANA 15', '', 5, 0, '', 0, NULL, '2015-05-12 06:59:17'),
	(31, 93, 1, 'SEMANA 16', '', 5, 0, '', 0, NULL, '2015-05-12 06:59:46'),
	(32, 93, 1, 'SEMANA 17', '', 5, 0, '', 0, NULL, '2015-05-12 06:59:55'),
	(33, 93, 1, 'SEMANA 18', '', 5, 0, '', 0, NULL, '2015-05-12 07:00:11'),
	(34, 93, 1, 'SEMANA 19', '', 5, 0, '', 0, NULL, '2015-05-12 07:00:21'),
	(35, 93, 1, 'SEMANA 20', '', 5, 0, '', 0, NULL, '2015-05-12 07:00:36');
...
CREATE TABLE IF NOT EXISTS `tema` (
  ...
  CONSTRAINT `FK_productoatributodetalle_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tema` (`PRODATRIBDET_Codigo`, `PRODATRIB_Codigo`, `COMPP_Codigo`, `PRODATRIBDET_Numero`, `PRODATRIBDET_Descripcion`, `PRODATRIBDET_Alternativa1`, `PRODATRIBDET_Alternativa2`, `PRODATRIBDET_Alternativa3`, `PRODATRIBDET_Alternativa4`, `PRODATRIBDET_Alternativa5`, `PRODATRIBDET_FlagCorrecta`, `PRODATRIBDET_FechaModificacion`, `PRODATRIBDET_FechaRegistro`) VALUES
	(36, 16, 1, 2, 'NOCIONES BASICAS', '', '', '', '', '', 0, NULL, '2015-03-05 04:09:05'),
	(38, 16, 1, 2, 'TRIANGULOS', '', '', '', '', '', 0, NULL, '2015-03-05 04:09:49'),
	(39, 17, 1, 1, 'CONGRUENCIA DE TRIANGULOS', 'ED', 'ED', 'ED', 'ED', 'ED', 1, NULL, '2015-04-04 08:01:31'),
	(40, 17, 1, 1, 'APLICACIONES DE LA CONGRUENCIA', '', '', '', '', '', 0, NULL, '2015-05-12 07:43:14'),
	(41, 18, 1, 1, 'TRIANGULOS RECTANGULOS NOTABLES', '', '', '', '', '', 0, NULL, '2015-05-12 07:43:57'),
	(42, 18, 1, 2, 'CUADRILATEROS', '', '', '', '', '', 0, NULL, '2015-05-12 07:44:21'),
	(43, 20, 1, 1, 'CIRCUNFERENCIA', '', '', '', '', '', 0, NULL, '2015-05-12 07:45:05'),
	(44, 20, 1, 2, 'CUADRILATERO CIRSCUNSCRITO Y CIRCUNSCRIPTE', '', '', '', '', '', 0, NULL, '2015-05-12 07:45:52'),
	(45, 19, 1, 1, 'ANGULOS EN LA CIRCUNFERENCIA', '', '', '', '', '', 0, NULL, '2015-05-12 07:46:24'),
	(46, 19, 1, 2, 'PROPORCIONALIDAD', '', '', '', '', '', 0, NULL, '2015-05-12 07:46:42'),
	(47, 21, 1, 1, 'SEMEJANZA DE TRIANGULOS', '', '', '', '', '', 0, NULL, '2015-05-12 07:47:06'),
	(48, 21, 1, 2, 'RECTA Y CIRCUNFERENCIA DE EULER', '', '', '', '', '', 0, NULL, '2015-05-12 07:47:36'),
	(49, 22, 1, 1, 'RELACIONES METRICAS EN EL TRIANGULO RECTANGULO', 'l', '', '', '', '', 0, NULL, '2015-05-12 07:48:45'),
	(50, 22, 1, 2, 'RELACIONES METRICAS EN EL TRIANGULO OBLICUANGULO', '', '', '', '', '', 0, NULL, '2015-05-12 07:50:05'),
	(51, 23, 1, 1, 'TEOREMA DE LAS CUERDAS', '', '', '', '', '', 0, NULL, '2015-05-12 07:50:31'),
	(52, 23, 1, 2, 'TEOREMA DEL TRIANGULO INSCRITO', '', '', '', '', '', 0, NULL, '2015-05-12 07:51:09'),
	(53, 24, 1, 1, 'POLIGONOS REGULARES', '', '', '', '', '', 0, NULL, '2015-05-12 07:51:30'),
	(54, 24, 1, 2, 'POLIGONOS REGULARES NOTABLES INSCRITOS', '', '', '', '', '', 0, NULL, '2015-05-12 07:51:48'),
	(55, 25, 1, 1, 'SIMETRIA EN EL PLANO', '', '', '', '', '', 0, NULL, '2015-05-12 07:52:49'),
	(56, 25, 1, 2, 'LONGITUD DE LA CIRCUNFERENCIA', '', '', '', '', '', 0, NULL, '2015-05-12 07:53:17'),
	(57, 26, 1, 1, 'AREAS DE REGIONES POLIGONALES', '', '', '', '', '', 0, NULL, '2015-05-12 07:53:48'),
	(58, 26, 1, 2, 'RELACION DE AREAS DE REGIONES TRIANGULARES', '', '', '', '', '', 0, NULL, '2015-05-12 07:54:19'),
	(59, 27, 1, 1, 'AREA DE REGIONES CUADRANGULARES', '', '', '', '', '', 0, NULL, '2015-05-12 07:54:48'),
	(60, 27, 1, 2, 'AREAS DE REGIONES CIRCULARES', '', '', '', '', '', 0, NULL, '2015-05-12 07:55:11'),
	(61, 28, 1, 1, 'ELEMENTOS DE GEOMETRIA EN EL ESPACIO', '', '', '', '', '', 0, NULL, '2015-05-12 07:55:50'),
	(62, 28, 1, 2, 'RECTA PERPENDICULAR A UN PLANO', '', '', '', '', '', 0, NULL, '2015-05-12 07:56:43'),
	(63, 29, 1, 1, 'ANGULO DIEDRO', '', '', '', '', '', 0, NULL, '2015-05-12 07:57:03'),
	(64, 29, 1, 2, 'ANGULO TRIEDRO', '', '', '', '', '', 0, NULL, '2015-05-12 07:57:18'),
	(65, 30, 1, 1, 'POLIEDROS', '', '', '', '', '', 0, NULL, '2015-05-12 07:57:35'),
	(66, 30, 1, 2, 'POLIEDROS REGULARES', '', '', '', '', '', 0, NULL, '2015-05-12 07:57:57'),
	(67, 31, 1, 1, 'SIMETRIA EN EL ESPACIO', '', '', '', '', '', 0, NULL, '2015-05-12 07:58:26'),
	(68, 31, 1, 2, 'SUPERFICIE PRISMATICA: PRISMA', '', '', '', '', '', 0, NULL, '2015-05-12 07:58:57'),
	(69, 32, 1, 1, 'DESARROLLOP DE LA SUPERFICIE LATERAL Y TOTAL DE UN PRISMA RECTO', '', '', '', '', '', 0, NULL, '2015-05-12 07:59:47'),
	(70, 32, 1, 2, 'SUPERFICIE PIRAMIDAL: PIRAMIDE', '', '', '', '', '', 0, NULL, '2015-05-12 08:00:11'),
	(71, 33, 1, 1, 'TRONCO DE PIRAMIDE', '', '', '', '', '', 0, NULL, '2015-05-12 08:00:27'),
	(72, 33, 1, 2, 'CILINDRO', '', '', '', '', '', 0, NULL, '2015-05-12 08:00:51'),
	(73, 34, 1, 1, 'CONO', '', '', '', '', '', 0, NULL, '2015-05-12 08:01:07'),
	(74, 34, 1, 2, 'SUPERFICIE ESFERICA', '', '', '', '', '', 0, NULL, '2015-05-12 08:01:25'),
	(75, 35, 1, 1, 'ESFERA', '', '', '', '', '', 0, NULL, '2015-05-12 08:01:42'),
	(76, 35, 1, 2, 'TEOREMA DE PAPPUS-GUIDING', '', '', '', '', '', 0, NULL, '2015-05-12 08:02:07');
...
CREATE TABLE IF NOT EXISTS `tipoestudio` (
  ...
  CONSTRAINT `FK_tipoestudio_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `tipoproducto` (
  ...
  CONSTRAINT `FK_tipoproducto_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
INSERT INTO `tipoproducto` (`TIPPROD_Codigo`, `COMPP_Codigo`, `TIPPROD_Descripcion`, `TIPPROD_FechaRegistro`, `TIPPROD_FechaModificacion`, `TIPPROD_FlagEstado`) VALUES
	(0, 1, ':::SELECCIONE::', '2014-10-06 14:37:56', NULL, '1'),
	(1, 1, 'MATEMATICAS', '2011-01-03 23:31:10', NULL, '1'),
	(2, 1, 'IDIOMAS', '2011-01-03 23:31:19', NULL, '1'),
	(3, 1, 'NEGOCIOS', '2011-01-03 23:31:33', NULL, '1');
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  CONSTRAINT `FK_usuario_compania` FOREIGN KEY (`COMPP_Codigo`) REFERENCES `ciclo_` (`COMPP_Codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `usuario` (`USUA_Codigo`, `COMPP_Codigo`, `PERSP_Codigo`, `ROL_Codigo`, `USUA_usuario`, `USUA_Password`, `USUA_FechaRegistro`, `USUA_FechaModificacion`, `USUA_FlagEstado`) VALUES
	(7, 1, 1, 4, 'demo', 'e10adc3949ba59abbe56e057f20f883e', '2014-09-24 15:23:31', NULL, '1');
